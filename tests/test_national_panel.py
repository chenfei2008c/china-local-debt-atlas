...
class NationalPanelTests(unittest.TestCase):
    ...
    def test_official_liaoning_2023_fund_execution_batch_uses_whole_city_values(self):
        root = Path(__file__).resolve().parents[1]
        values, sources = load_regional_fiscal_sources(root)
        self.assertEqual(values[("CN-210400", "2023")]["gov_fund_revenue_100m"], Decimal("5.2"))
        ...
        self.assertEqual(
            values[("CN-210500", "2023")]["_field_sources"]["gov_fund_revenue_100m"]["source_grade"],
            "A2",
        )
        self.assertEqual(
            values[("CN-211100", "2023")]["_field_sources"]["gov_fund_revenue_100m"]["source_grade"],
            "A2",
        )
        source_ids = {item["source_doc_id"] for item in sources}
    ...
    def test_shaanxi_2024_regional_table_extracts_economic_and_fiscal_fields(self):
        ...
        expected = {
            ...
            "CN-610800": ("7548.68", "6.0", "618.90", "76.20"),
    ...
    def test_city_year_fund_batch_extracts_hohhot_and_chifeng(self):
        ...
        self.assertEqual(values[("CN-150500", "2025")]["gov_fund_revenue_100m"], Decimal("69.48"))
        self.assertEqual(values[("CN-150600", "2025")]["gov_fund_revenue_100m"], Decimal("97.40"))
        self.assertEqual(values[("CN-411500", "2025")]["gov_fund_revenue_100m"], Decimal("134.98"))
        self.assertEqual(values[("CN-511700", "2025")]["gov_fund_revenue_100m"], Decimal("197.30"))
        ...
        self.assertEqual(values[("CN-140300", "2025")]["gov_fund_revenue_100m"], Decimal("24.78"))
        self.assertEqual(values[("CN-231000", "2025")]["gov_fund_revenue_100m"], Decimal("26.52"))
        self.assertEqual(values[("CN-341000", "2025")]["gov_fund_revenue_100m"], Decimal("40.60"))
        self.assertEqual(values[("CN-640300", "2025")]["gov_fund_revenue_100m"], Decimal("20.71"))
        self.assertEqual(values[("CN-420500", "2025")]["gov_fund_revenue_100m"], Decimal("15.04"))
        self.assertEqual(values[("CN-420500", "2025")]["data_status"], "budget")
        self.assertEqual(values[("CN-460400", "2025")]["gov_fund_revenue_100m"], Decimal("18.71"))
        self.assertEqual(values[("CN-460400", "2025")]["data_status"], "budget")
        self.assertEqual(values[("CN-445200", "2025")]["gov_fund_revenue_100m"], Decimal("73.77"))
        self.assertEqual(values[("CN-445200", "2025")]["data_status"], "budget")
        self.assertEqual(values[("CN-445100", "2025")]["gov_fund_revenue_100m"], Decimal("31.41"))
        self.assertEqual(values[("CN-445100", "2025")]["data_status"], "budget")
        self.assertEqual(values[("CN-441800", "2025")]["gov_fund_revenue_100m"], Decimal("130.09"))
        self.assertEqual(values[("CN-441800", "2025")]["data_status"], "budget")
        self.assertEqual(values[("CN-610800", "2025")]["gov_fund_revenue_100m"], Decimal("67.29"))
        self.assertEqual(values[("CN-610800", "2025")]["source_grade"], "A1")
        self.assertEqual(values[("CN-410400", "2025")]["gov_fund_revenue_100m"], Decimal("70.30"))
        self.assertEqual(values[("CN-411000", "2025")]["gov_fund_revenue_100m"], Decimal("80.10"))
        self.assertEqual(values[("CN-411000", "2025")]["data_status"], "execution")
        self.assertEqual(values[("CN-411000", "2025")]["source_grade"], "A2")
