...
CITY_IDS = {
    ...
    "宣城市": "CN-341800",
    # 福建
    "福州市": "CN-350100", "厦门市": "CN-350200", "莆田市": "CN-350300",
    "三明市": "CN-350400", "泉州市": "CN-350500", "漳州市": "CN-350600",
    "南平市": "CN-350700", "龙岩市": "CN-350800", "宁德市": "CN-350900",
    # 河北
    ...
    "黔西南布依族苗族自治州": "CN-522300", "黔东南苗族侗族自治州": "CN-522600",
    "黔南布依族苗族自治州": "CN-522700",
    # 新疆（本批仅录入表格明确给出的8个缺口城市/地区）
    "克拉玛依市": "CN-650200", "吐鲁番市": "CN-650400", "哈密市": "CN-650500",
    "阿克苏地区": "CN-652900", "克孜勒苏柯尔克孜自治州": "CN-653000",
    "和田地区": "CN-653200", "伊犁哈萨克自治州": "CN-654000", "阿勒泰地区": "CN-654300",
}
...
SOURCE_SPECS = {
    ...
    "SRC-B2-REGIONAL-HANDBOOK-2022-FUND-BATCH": {
        "year": 2022,
        "path": "raw/province_fiscal/2022/secondary/regional_handbook_2022_fund_batch_excerpt.txt",
        "text_path": "raw/province_fiscal/2022/secondary/regional_handbook_2022_fund_batch_excerpt.txt",
        "url": "https://www.scribd.com/document/911238563/2023%E5%8C%BA%E5%9F%9F%E7%BB%8F%E6%B5%8E%E6%89%8B%E5%86%8C%E7%94%B5%E5%AD%90%E7%89%88",
        "title": "2023区域经济手册电子版",
        "publisher": "公开区域经济资料整理方（Scribd公开页面）",
        "publication_date": "2023-01-01",
        "page_number": "网页摘录第016、028、040、064—065、093页：2022年下属辖区主要指标",
        "source_grade": "B2",
        "source_format": "txt",
        "data_status": "final",
        "note": "B2精确表格；公开页面按省份列示2022年地级行政单元全市/全州口径。本批只提取河北、吉林、浙江、广东、陕西缺口城市中表格明确给出的政府性基金收入；‘—’不转换为零，不覆盖已有值。",
    },
    "SRC-B2-REGIONAL-HANDBOOK-2022-FUND-BATCH-2": {
        "year": 2022,
        "path": "raw/province_fiscal/2022/secondary/regional_handbook_2022_fund_batch_2_excerpt.txt",
        "text_path": "raw/province_fiscal/2022/secondary/regional_handbook_2022_fund_batch_2_excerpt.txt",
        "url": "https://www.scribd.com/document/911238563/2023%E5%8C%BA%E5%9F%9F%E7%BB%8F%E6%B5%8E%E6%89%8B%E5%86%8C%E7%94%B5%E5%AD%90%E7%89%88",
        "title": "2023区域经济手册电子版",
        "publisher": "公开区域经济资料整理方（Scribd公开页面）",
        "publication_date": "2023-01-01",
        "page_number": "网页摘录第022、043、046、084、105—106页：2022年下属辖区主要指标",
        "source_grade": "B2",
        "source_format": "txt",
        "data_status": "final",
...
# 同一公开区域表的跨省批次；仅录入主表当前为空且表格给出精确数值的城市。
for city, fund in [
    # 河北省（网页摘录第016页）
    ("石家庄市", "365.91"), ("唐山市", "299.43"), ("秦皇岛市", "84.36"),
    ("邯郸市", "210.31"), ("邢台市", "132.30"), ("张家口市", "118.12"),
    ("承德市", "34.05"), ("沧州市", "151.11"), ("廊坊市", "146.79"),
    ("衡水市", "72.78"),
    # 吉林省（网页摘录第028页）
    ("长春市", "189.45"), ("辽源市", "12.55"), ("通化市", "20.32"),
    ("延边朝鲜族自治州", "19.80"),
    # 浙江省（网页摘录第040页）
    ("杭州市", "3202.24"), ("温州市", "1156.56"), ("嘉兴市", "855.04"),
    ("绍兴市", "727.73"), ("金华市", "844.94"), ("衢州市", "372.18"),
    ("舟山市", "82.72"), ("台州市", "713.38"), ("丽水市", "309.09"),
    # 广东省（网页摘录第064—065页；仅提取原表有精确值的缺口城市）
    ("茂名市", "79.58"), ("阳江市", "38.94"), ("东莞市", "411.02"),
    ("潮州市", "18.25"), ("揭阳市", "33.84"), ("云浮市", "20.02"),
    # 陕西省（网页摘录第093页）
    ("西安市", "1262.94"), ("铜川市", "11.76"), ("宝鸡市", "58.97"),
    ("咸阳市", "112.17"), ("渭南市", "67.60"), ("延安市", "36.44"),
    ("汉中市", "43.69"), ("榆林市", "72.10"), ("安康市", "43.41"),
    ("商洛市", "25.33"),
]:
    ROWS.append(_r("SRC-B2-REGIONAL-HANDBOOK-2022-FUND-BATCH", city, 2022, gov_fund_revenue_100m=fund))

for city, fund in [
    # 福建省（网页摘录第046页）
    ("福州市", "617.34"), ("莆田市", "91.07"), ("三明市", "62.96"),
    ("漳州市", "225.23"), ("南平市", "74.21"), ("龙岩市", "78.85"),
    ("宁德市", "102.01"),
    # 贵州省（网页摘录第084页）
    ("六盘水市", "105.30"), ("安顺市", "72.14"), ("毕节市", "150.00"),
    ("铜仁市", "117.97"), ("黔西南布依族苗族自治州", "97.51"),
    ("黔东南苗族侗族自治州", "90.00"), ("黔南布依族苗族自治州", "203.22"),
    # 内蒙古自治区（网页摘录第022页；赤峰市原表为“—”）
    ("乌海市", "11.50"), ("通辽市", "31.90"), ("呼伦贝尔市", "12.87"),
    ("巴彦淖尔市", "11.00"), ("乌兰察布市", "18.40"), ("兴安盟", "12.47"),
    ("阿拉善盟", "6.41"),
    # 新疆维吾尔自治区（网页摘录第105—106页；不使用兵团汇总替代自治区直辖县级行政区划）
    ("克拉玛依市", "11.53"), ("吐鲁番市", "9.75"), ("哈密市", "14.66"),
    ("阿克苏地区", "40.82"), ("克孜勒苏柯尔克孜自治州", "4.61"),
