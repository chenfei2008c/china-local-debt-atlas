...
try:
    ...
    from scripts.xueyan_fund_preview import PUBLIC_PREVIEW_FUND_SOURCES as XUEYAN_PUBLIC_PREVIEW_FUND_SOURCES
    ...
    from scripts.hainan_direct_admin_2025_monthly import HAINAN_DIRECT_ADMIN_2025_MONTHLY_SOURCE
    ...
    from xueyan_fund_preview import PUBLIC_PREVIEW_FUND_SOURCES as XUEYAN_PUBLIC_PREVIEW_FUND_SOURCES
    ...
    from hainan_direct_admin_2025_monthly import HAINAN_DIRECT_ADMIN_2025_MONTHLY_SOURCE
...
CITY_YEAR_FUND_SOURCES += (
    {
        ...
        "city_name": "广安市",
        "city_id": "CN-511600",
        "source_doc_id": "SRC-A2-GUANGAN-CITY-FUND-EXECUTION-2024",
        "url": "https://www.scyc.gov.cn/zfxxgk/c105083/pc/content/content_1883432203647004672.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "guangan_2024_fund_execution.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "guangan_2024_fund_execution_excerpt.txt",
        "document_title": "广安市2024年政府性基金预算收入执行情况表",
        "publisher": "广安市财政局",
        "publisher_level": "市级财政机构官网",
        "publication_date": "2025-01-26",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"全市政府性基金收入执行数：([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2024年全市政府性基金预算收入执行数",
        "document_type": "市级财政预算执行表",
        "page_number": "PDF第1页（印刷页33）",
        "page_count": "1",
        "note": "A2市级财政局官网附件7，表格明确列示全市收入合计执行数1169678万元；行政范围为广安市全市，不使用市级表，也不将预算数或变动预算数代替执行数。",
    },
    {
        "year": 2024,
        "city_name": "吕梁市",
...
# 广东省 2022 年全市政府性基金收入补缺批次。广州、江门、梅州为官方决算/预算
# 公开 PDF，湛江、汕尾为官方财政网页，汕头为官方人大公开附件的精确表格摘录。
# 所有值均明确为全市口径；同一材料中的市本级数只作为排除性证据，不写入主表。
CITY_YEAR_FUND_SOURCES += (
    {
        "year": 2022,
        "city_name": "广州市",
        "city_id": "CN-440100",
        "source_doc_id": "SRC-A2-GUANGZHOU-CITY-FUND-2022",
        "url": "https://www.gz.gov.cn/attachment/7/7224/7224599/8770018.pdf",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "guangzhou_2022_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "guangzhou_2022_fund_excerpt.txt",
        "document_title": "关于广州市2022年预算执行情况和2023年预算的报告",
        "publisher": "广州市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2023-01-18",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"政府性基金收入\|[0-9,]+\|([0-9,]+)\|",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2022年执行数",
        "document_type": "城市政府决算/预算执行报告（官方PDF）",
        "page_number": "179",
        "page_count": "285",
        "note": "A2官方预算报表第179页表24，明确为2022年全市政府性基金预算收入执行情况表；执行数16292108万元，不使用市级表数。",
    },
    {
        "year": 2022,
        "city_name": "汕头市",
        "city_id": "CN-440500",
        "source_doc_id": "SRC-A2-SHANTOU-CITY-FUND-2022",
        "url": "https://rd.shantou.gov.cn/rd/sjyjs/202301/0ef1d5496f0c4325a0621f6f76e9a353/files/1-1%E9%99%84%E4%BB%B6%EF%BC%9A%E6%B1%95%E5%A4%B4%E5%B8%822022%E5%B9%B4%E9%A2%84%E7%AE%97%E6%89%A7%E8%A1%8C%E6%83%85%E5%86%B5%E5%92%8C2023%E5%B9%B4%E9%A2%84%E7%AE%97%E8%8D%89%E6%A1%88.pdf",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "shantou_2022_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "shantou_2022_fund_excerpt.txt",
        "document_title": "汕头市2022年预算执行情况和2023年预算草案的报告（附表5）",
        "publisher": "汕头市人大、汕头市财政局",
        "publisher_level": "市级人大/财政公开",
        "publication_date": "2023-01-09",
        "source_grade": "A2",
        "source_format": "txt",
        "pattern": r"政府性基金收入\|[0-9,]+\|[0-9,]+\|[0-9,]+\|([0-9,]+)\|",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2022年执行数",
        "document_type": "城市政府预算执行表精确摘录（官方附件入口）",
        "page_number": "PDF第5页，附表5",
        "page_count": "17",
        "note": "A2官方人大公开附件精确表格；第5页为汕头市全市表，执行数524936万元；第6页另列市本级225259万元，明确不采用市本级数。原始PDF直链受站点访问限制，保留官方附件入口页与字段摘录。",
    },
    {
        "year": 2022,
        "city_name": "湛江市",
        "city_id": "CN-440800",
        "source_doc_id": "SRC-A2-ZHANJIANG-CITY-FUND-2022",
        "url": "https://www.zhanjiang.gov.cn/zdlyxxgk/czyjshsg/czyjs/content/mpost_1805543.html",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "zhanjiang_2022_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "zhanjiang_2022_fund_excerpt.txt",
        "document_title": "湛江市2022年预算执行情况和2023年预算草案的报告",
        "publisher": "湛江市财政局",
        "publisher_level": "市级财政机构",
        ...
        "data_status": "final",
        "data_status_label": "2022年决算数",
        "document_type": "城市政府决算报告（官方网页）",
        "page_number": "网页正文",
        "page_count": "1",
        "note": "A2湛江市财政决算公开网页，正文明确披露2022年全市政府性基金预算收入76.75亿元，并区分市本级等口径。",
    },
    {
        "year": 2022,
        "city_name": "江门市",
        "city_id": "CN-440700",
        "source_doc_id": "SRC-A2-JIANGMEN-CITY-FUND-2022",
        "url": "https://www.jiangmen.gov.cn/attachment/0/282/282040/2941035.pdf",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "jiangmen_2022_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "jiangmen_2022_fund_excerpt.txt",
        "document_title": "2022年江门市本级政府决算公开",
        "publisher": "江门市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2023-09-21",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"2022年全市政府性基金预算收入完成([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "final",
        "data_status_label": "2022年决算数",
        "document_type": "城市政府决算报告（官方PDF）",
        "page_number": "4",
        "page_count": "153",
        "note": "A2官方决算报告第4页，明确披露2022年全市政府性基金预算收入141.30亿元；不使用第12页市本级26.30亿元。",
    },
    {
        "year": 2022,
        "city_name": "汕尾市",
        "city_id": "CN-441500",
        "source_doc_id": "SRC-A2-SHANWEI-CITY-FUND-2022",
        "url": "https://www.shanwei.gov.cn/swczj/yaowen/tzgg/content/post_893084.html",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "shanwei_2022_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "shanwei_2022_fund_excerpt.txt",
        "document_title": "汕尾市2022年预算执行情况和2023年预算草案报告",
        "publisher": "汕尾市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2023-02-08",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"全市地方政府性基金预算收入([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2022年执行数",
        "document_type": "城市政府预算执行报告（官方网页）",
        "page_number": "网页正文",
        "page_count": "1",
        "note": "A2汕尾市财政局官方网页，明确披露2022年全市地方政府性基金预算收入341939万元；不使用另列的市级口径。",
    },
    {
        "year": 2022,
        "city_name": "梅州市",
        "city_id": "CN-441400",
        "source_doc_id": "SRC-A2-MEIZHOU-CITY-FUND-2022",
        "url": "https://www.meizhou.gov.cn/attachment/0/171/171063/2550359.pdf",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "meizhou_2022_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "meizhou_2022_fund_excerpt.txt",
        "document_title": "2022年梅州市市级政府决算公开",
        "publisher": "梅州市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2023-09-26",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"2022年全市政府性基金预算收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "final",
        "data_status_label": "2022年决算数",
        "document_type": "城市政府决算报告（官方PDF）",
        "page_number": "25",
        "page_count": "96",
        "note": "A2官方决算报告第25页全市汇编口径，明确披露2022年全市政府性基金预算收入22.78亿元；不使用第73页市级31,211万元。",
    },
    {
        "year": 2024,
        "city_name": "聊城市",
        "city_id": "CN-371500",
        "source_doc_id": "SRC-B2-LIAOCHENG-CITY-FUND-2024",
        ...
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "liaocheng_2024_rating_report_excerpt.txt",
        ...
        "page_number": "PDF第13页",
        "page_count": "",
        "note": "B2精确表格；报告明确列示聊城市全市2024年政府性基金预算收入187.03亿元，来源注明统计公报及财政执行资料，不使用市本级数。",
    },
    {
        "year": 2022,
        "city_name": "周口市",
        "city_id": "CN-411600",
        "source_doc_id": "SRC-A2-HENAN-ZHOUKOU-FUND-2022",
        "url": "https://www.zhoukou.gov.cn/sitesources/zksrmzf/page_pc/ztzl/2023nztzl/2023nlhzt/qwfb/articlef3cedaf277d04de0a5d5613756217ede.html",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "zhoukou_2022_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "zhoukou_2022_fund_excerpt.txt",
        "document_title": "周口市2022年预算执行情况和2023年预算草案报告解读",
        "publisher": "周口市人民政府门户",
        "publisher_level": "市级政府门户",
        "publication_date": "2023-02-02",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"原文摘录：.*?全市政府性基金预算收入完成([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2022年执行数",
        "document_type": "城市财政预算执行报告解读（官方网页）",
        "page_number": "网页正文：政府性基金预算",
        "page_count": "1",
        "note": "A2官方网页；原文同时区分全市与市级口径，本条采用全市政府性基金预算收入完成105.7亿元，不使用市级16.7亿元。",
    },
    {
        "year": 2023,
        "city_name": "周口市",
        "city_id": "CN-411600",
        "source_doc_id": "SRC-A2-HENAN-ZHOUKOU-FUND-2023",
        "url": "https://czj.zhoukou.gov.cn/sitesources/czj/upload/d28918ed2e6a4fecc777b7bc8d52df9e/1709605393900.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "zhoukou_2023_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "zhoukou_2023_fund_excerpt.txt",
        "document_title": "关于周口市2023年预算执行情况和2024年预算草案的报告",
        "publisher": "周口市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2024-03-05",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"原文摘录：.*?全市政府性基金预算收入实际完成([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2023年执行数",
        "document_type": "城市财政预算执行报告（官方PDF）",
        "page_number": "PDF第7页：政府性基金预算",
        "page_count": "",
        "note": "A2官方财政局PDF；报告披露全市政府性基金预算收入实际完成127.7亿元，采用全市执行口径。",
    },
    {
        "year": 2023,
        "city_name": "洛阳市",
        "city_id": "CN-410300",
        "source_doc_id": "SRC-A2-HENAN-LUOYANG-FUND-2023",
        "url": "https://oss.ly.gov.cn/upload-file/files/20240920/9dbd9b45ad8a4bedb3a2a2a8a5b75bf2.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "luoyang_2023_2024_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "luoyang_2023_fund_excerpt.txt",
        "document_title": "关于洛阳市2023年财政决算和2024年财政预算执行情况的报告",
        "publisher": "洛阳市财政局",
        "publisher_level": "市级财政机构",
        ...
        "data_status": "final",
        "data_status_label": "2023年决算数",
        "document_type": "城市财政决算报告（官方PDF）",
        "page_number": "PDF：政府性基金预算执行情况",
        "page_count": "",
        "note": "A2官方财政局PDF；报告披露洛阳市全市2023年政府性基金预算收入完成196.1亿元，不使用市本级口径。",
    },
    {
        "year": 2024,
        "city_name": "洛阳市",
        "city_id": "CN-410300",
        "source_doc_id": "SRC-A2-HENAN-LUOYANG-FUND-2024",
        "url": "https://oss.ly.gov.cn/upload-file/files/20240920/9dbd9b45ad8a4bedb3a2a2a8a5b75bf2.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "luoyang_2023_2024_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "luoyang_2024_fund_excerpt.txt",
        "document_title": "关于洛阳市2024年预算执行情况和2025年预算草案的报告",
        "publisher": "洛阳市财政局",
        "publisher_level": "市级财政机构",
        ...
        "page_number": "PDF：政府性基金预算执行情况",
        "page_count": "",
        "note": "A2官方财政局PDF；报告披露洛阳市全市2024年政府性基金预算收入完成36.2亿元，采用全市执行口径。",
    },
    {
        "year": 2024,
        "city_name": "郑州市",
        "city_id": "CN-410100",
        "source_doc_id": "SRC-A2-HENAN-ZHENGZHOU-FUND-2024",
        "url": "https://public.zhengzhou.gov.cn/D190101X/9183261.jhtml",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "zhengzhou_2024_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "zhengzhou_2024_fund_excerpt.txt",
        "document_title": "关于郑州市2024年财政决算和2025年财政预算草案的报告",
        "publisher": "郑州市财政局",
        "publisher_level": "市级财政机构官方公开平台",
        "publication_date": "2025-09-26",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"原文摘录：.*?2024年全市政府性基金收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "final",
        "data_status_label": "2024年决算数",
        "document_type": "城市财政决算说明入口页及附件（官方网页）",
        "page_number": "附件第12页：全市及市级决算说明",
        "page_count": "",
        "note": "A2官方公开平台及决算说明附件；采用2024年全市政府性基金收入347.7亿元，不使用市本级数。",
    },
    {
        "year": 2024,
        "city_name": "新乡市",
        "city_id": "CN-410700",
        "source_doc_id": "SRC-A2-HENAN-XINXIANG-FUND-2024",
        "url": "https://rb.xxrb.com.cn/app_epaper/2025-02/10/content_9941585.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "xinxiang_2024_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "xinxiang_2024_fund_excerpt.txt",
        "document_title": "关于新乡市2024年预算执行情况和2025年预算草案的报告（摘要）",
        "publisher": "新乡日报",
        "publisher_level": "市级官方报纸",
        "publication_date": "2025-02-10",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"原文摘录：.*?实际完成([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2024年执行数",
        "document_type": "城市财政预算执行报告摘要（官方报纸网页）",
        "page_number": "网页正文：政府性基金预算",
        "page_count": "1",
        "note": "A2官方报纸精确转载；原文同时披露调整预算62.6亿元和实际完成63.1亿元，本条采用全市实际完成数。",
    },
    {
        "year": 2024,
        "city_name": "焦作市",
        "city_id": "CN-410800",
        "source_doc_id": "SRC-A2-HENAN-JIAOZUO-FUND-2024",
        "url": "https://czj.jiaozuo.gov.cn/2025/02-24/269393.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "jiaozuo_2024_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "jiaozuo_2024_fund_excerpt.txt",
        "document_title": "焦作市2024年财政预算执行情况分析",
        "publisher": "焦作市财政局",
        "publisher_level": "市级财政机构",
        ...
        "data_status": "execution",
        "data_status_label": "2024年执行数",
        "document_type": "城市财政执行分析（官方网页）",
        "page_number": "网页正文：政府性基金预算收入",
        "page_count": "1",
        "note": "A2焦作市财政局官方网页；明确披露全市政府性基金预算收入完成1.8亿元，采用全市口径。",
    },
    {
        "year": 2024,
        "city_name": "平顶山市",
        "city_id": "CN-410400",
        "source_doc_id": "SRC-A2-HENAN-PINGDINGSHAN-FUND-2024",
        "url": "https://www.pds.gov.cn/contents/1378/432272.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "pingdingshan_2024_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "pingdingshan_2024_fund_excerpt.txt",
        "document_title": "关于平顶山市2024年预算执行情况和2025年预算草案的报告",
        "publisher": "平顶山市人民政府",
        "publisher_level": "市级政府门户",
        "publication_date": "2025-01-20",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"原文摘录：.*?2024年政府性基金预算收入，实际完成([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2024年执行数",
        "document_type": "城市财政预算执行报告（官方网页）",
        "page_number": "网页正文：政府性基金预算",
        "page_count": "1",
        "note": "A2平顶山市政府门户官方网页；采用汇总全市各级口径实际完成641176万元，折算为64.12亿元，不使用市本级169183万元。",
    },
    {
        "year": 2024,
        "city_name": "信阳市",
        "city_id": "CN-411500",
        "source_doc_id": "SRC-A2-HENAN-XINYANG-FUND-2024",
        "url": "https://m.xinyang.gov.cn/2025/09-30/740183.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "xinyang_2024_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "xinyang_2024_fund_excerpt.txt",
        "document_title": "关于信阳市2024年财政决算和2025年预算草案的报告",
        "publisher": "信阳市人民政府",
        "publisher_level": "市级政府门户",
        ...
        "page_number": "网页正文：政府性基金预算",
        "page_count": "1",
        "note": "A2信阳市政府官方网页；正文同时区分全市与市级口径，采用全市政府性基金收入完成79.81亿元。",
    },
    {
        "year": 2025,
        "city_name": "许昌市",
        "city_id": "CN-411000",
        "source_doc_id": "SRC-A2-XUCHANG-CITY-FUND-2025",
        "url": "https://www.xuchang.gov.cn/uploadfile/13fe19da-4682-4f9f-b9b1-85b79109ec93/%E5%85%B3%E4%BA%8E%E8%AE%B8%E6%98%8C%E5%B8%822025%E5%B9%B4%E9%A2%84%E7%AE%97%E6%89%A7%E8%A1%8C%E6%83%85%E5%86%B5%E5%92%8C2026%E5%B9%B4%E9%A2%84%E7%AE%97%E8%8D%89%E6%A1%88%E7%9A%84%E6%8A%A5%E5%91%8A.pdf",
        "landing_page_url": "https://www.xuchang.gov.cn/czyjsgkpt/034001/034001001/034001001012/20260225/13fe19da-4682-4f9f-b9b1-85b79109ec93.html",
        "attachment_url": "https://www.xuchang.gov.cn/uploadfile/13fe19da-4682-4f9f-b9b1-85b79109ec93/%E5%85%B3%E4%BA%8E%E8%AE%B8%E6%98%8C%E5%B8%822025%E5%B9%B4%E9%A2%84%E7%AE%97%E6%89%A7%E8%A1%8C%E6%83%85%E5%86%B5%E5%92%8C2026%E5%B9%B4%E9%A2%84%E7%AE%97%E8%8D%89%E6%A1%88%E7%9A%84%E6%8A%A5%E5%91%8A.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "xuchang_2025_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "xuchang_2025_budget_execution_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于许昌市2025年预算执行情况和2026年预算草案的报告",
        "publisher": "许昌市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2026-02-25",
        "source_grade": "A2",
        ...
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2025年执行数（官方预算执行报告，初步预计汇总数）",
        "document_type": "城市财政预算执行报告（官方PDF）",
        "page_number": "PDF第2页",
        "pattern": r"2025年，全市政府性基金收入预算130\.7亿元，执行中调整为110\.1亿元，实际完成([0-9.]+)亿元",
        "note": "A2许昌市财政局官方预算执行报告；报告明确区分全市与市本级，采用2025年全市政府性基金实际完成80.1亿元。报告说明该年度数据为初步预计汇总数，标记execution，不冒充最终决算。",
    },
    {
        "year": 2024,
        "city_name": "沈阳市",
        "city_id": "CN-210100",
        "source_doc_id": "SRC-A2-SHENYANG-CITY-FUND-2024",
        "url": "https://www.shenyang.gov.cn/zx/fjk/202501/P020250126402561959346.pdf",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "shenyang_2024_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "shenyang_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于沈阳市2024年预算执行情况和2025年预算草案的报告",
        "publisher": "沈阳市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-01-12",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"2024年全市政府性基金预算收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2024年执行数（快报数）",
        "document_type": "城市财政预算执行报告（官方PDF）",
        "page_number": "PDF第16页",
        "page_count": "38",
        "note": "A2沈阳市财政局官方报告；正文明确披露全市政府性基金预算收入171.6亿元，并另列市本级13.5亿元，采用全市口径；报告说明为快报数，标记execution。",
    },
    {
        "year": 2025,
        "city_name": "沈阳市",
        "city_id": "CN-210100",
        "source_doc_id": "SRC-A2-SHENYANG-CITY-FUND-2025",
        "url": "https://www.shenyang.gov.cn/zx/fjk/202602/P020260421597336953889.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "shenyang_2025_budget_execution_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "shenyang_2025_budget_execution_report_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于沈阳市2025年预算执行情况和2026年预算草案的报告（书面）",
        "publisher": "沈阳市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2026-01-14",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"政府性基金预算收入合计1,716,390(1,036,382)",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2025年快报执行数（官方预算执行报告）",
        "document_type": "城市财政预算执行报告（官方PDF）",
        "page_number": "PDF第49页（印刷页41）；全市2025年政府性基金预算收入执行情况表；政府性基金预算收入合计行",
        "page_count": "35",
        "note": "A2沈阳市财政局官方预算执行报告；表41明确列示2025年全市政府性基金预算收入快报数1,036,382万元，换算为103.6382亿元；采用全市口径，不使用市本级306,790万元，保留execution状态，不冒充最终决算。",
    },
    {
        "year": 2024,
        "city_name": "抚顺市",
        "city_id": "CN-210400",
        "source_doc_id": "SRC-A2-FUSHUN-CITY-FUND-2024",
        "url": "https://www.fushun.gov.cn/zwgk/002008/002008003/002008003001/20250718/e1065c27-357f-4572-95dc-ed8edc515c7c.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "fushun_2024_final_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "fushun_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于抚顺市2024年财政决算的报告",
        "publisher": "抚顺市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-07-18",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"2024年全市政府性基金收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "final",
        "data_status_label": "2024年决算数",
        "document_type": "城市财政决算报告（官方网页）",
        "page_number": "网页正文：政府性基金预算收支情况",
        "page_count": "1",
        "note": "A2抚顺市财政局官方决算报告；明确披露全市政府性基金收入13.2亿元，采用全市口径。",
    },
    {
        "year": 2024,
        "city_name": "本溪市",
        "city_id": "CN-210500",
        "source_doc_id": "SRC-A2-BENXI-CITY-FUND-2024",
        "url": "https://www.benxi.gov.cn/publicity/szfxx/czyjs/zfys/127512",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "benxi_2024_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "benxi_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于本溪市2024年预算执行情况和2025年预算草案的报告",
        "publisher": "本溪市财政局",
        "publisher_level": "市级政府门户",
        "publication_date": "2025-01-20",
        "source_grade": "A2",
        ...
        "page_count": "1",
        "note": "A2本溪市政府门户官方报告；明确区分全市与市本级，采用全市政府性基金预算收入8.1亿元。",
    },
    {
        "year": 2024,
        "city_name": "盘锦市",
        "city_id": "CN-211100",
        "source_doc_id": "SRC-A2-PANJIN-CITY-FUND-2024",
        "url": "https://czj.panjin.gov.cn/2025_01/08_10/content-508554.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "panjin_2024_budget_execution.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "panjin_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "盘锦市2024年财政预算执行情况",
        "publisher": "盘锦市财政局",
        "publisher_level": "市级财政机构",
        ...
        "page_number": "网页正文：政府性基金预算收入",
        "page_count": "1",
        "note": "A2盘锦市财政局官方执行情况页面；采用全市政府性基金预算收入12.8亿元，不使用市本级数。",
    },
    {
        "year": 2024,
        "city_name": "衡阳市",
        "city_id": "CN-430400",
        "source_doc_id": "SRC-A2-HENGYANG-CITY-FUND-2024-FINAL",
        "url": "https://www.hengyang.gov.cn/czj/ztxx/czysjsgk/cxzyhyjsgk/ysjsbg/20250905/i3781107.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "hengyang_2024_final_report_snapshot.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "hengyang_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于衡阳市2024年市级决算草案和2025年上半年预算执行情况的报告",
        "publisher": "衡阳市财政局",
        "publisher_level": "市级财政机构",
        ...
        "data_status_label": "2024年决算数",
        "document_type": "城市财政决算报告（官方网页）",
        "page_number": "网页正文：政府性基金预算收支决算情况",
        "page_count": "1",
        "note": "A2衡阳市财政局官方决算报告；采用全市政府性基金预算收入142.18亿元，覆盖市本级及各县市区。",
    },
    {
        "year": 2024,
        "city_name": "益阳市",
        "city_id": "CN-430900",
        "source_doc_id": "SRC-A2-YIYANG-CITY-FUND-2024",
        "url": "https://www.yiyang.gov.cn/czj/5841/5844/5860/content_2031902.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "yiyang_2024_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "yiyang_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于益阳市2024年预算执行情况与2025年预算草案的报告",
        "publisher": "益阳市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-01-20",
        "source_grade": "A2",
        ...
        "page_number": "网页正文：政府性基金预算执行情况",
        "page_count": "1",
        "note": "A2益阳市财政局官方预算报告；明确披露全市政府性基金预算收入26.34亿元，采用全市口径。",
    },
    {
        "year": 2024,
        "city_name": "六安市",
        "city_id": "CN-341500",
        "source_doc_id": "SRC-A2-LUAN-CITY-FUND-2024",
        "url": "https://czj.luan.gov.cn/public/6608251/10655028.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "luan_2024_budget_analysis.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "luan_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "2024年全市预算执行情况分析",
        "publisher": "六安市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-01-20",
        "source_grade": "A2",
        ...
        "page_number": "网页正文：政府性基金预算执行情况",
        "page_count": "1",
        "note": "A2六安市财政局官方预算执行分析；明确为全市口径，采用政府性基金预算收入56.3亿元。",
    },
    {
        "year": 2024,
        "city_name": "黄山市",
        "city_id": "CN-341000",
        "source_doc_id": "SRC-A2-HUANGSHAN-CITY-FUND-2024-FINAL",
        "url": "https://www.huangshan.gov.cn/zwgk/public/6615714/11891414.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "huangshan_2024_final_report_snapshot.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "huangshan_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于黄山市2024年度财政决算和2025年上半年预算执行情况的报告",
        "publisher": "黄山市财政局",
        "publisher_level": "市级财政机构",
        ...
        "page_number": "网页正文：政府性基金预算收支决算情况",
        "page_count": "1",
        "note": "A2黄山市财政局官方决算报告；明确披露全市政府性基金预算收入41.2亿元，采用全市口径。",
    },
    {
        "year": 2024,
        "city_name": "永州市",
        "city_id": "CN-431100",
        "source_doc_id": "SRC-A2-YONGZHOU-CITY-FUND-2024-FINAL",
        "url": "https://czj.yzcity.gov.cn/czj/030701/202607/64749da709bf48b896af33c2bbdac257.shtml",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "yongzhou_2024_final_report_snapshot.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "yongzhou_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于永州市2024年市级决算草案和2025年上半年预算执行情况的报告",
        "publisher": "永州市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-09-10",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"2024年，全市政府性基金收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "final",
        "data_status_label": "2024年决算数",
        "document_type": "城市财政决算报告（官方网页）",
        "page_number": "网页正文：全市财政收支决算情况",
        "page_count": "1",
        "note": "A2永州市财政局官方决算报告；明确披露2024年全市政府性基金收入150.05亿元，采用全市口径。",
    },
    {
        "year": 2024,
        "city_name": "防城港市",
        "city_id": "CN-450600",
        "source_doc_id": "SRC-A2-FANGCHENGGANG-CITY-FUND-2024",
        "url": "https://www.fcgs.gov.cn/czj/sbjyspt/t19673607.shtml",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "fangchenggang_2024_budget_report_snapshot.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "fangchenggang_2024_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于防城港市全市与市本级2024年预算执行情况和2025年预算草案的报告",
        "publisher": "防城港市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-07-14",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"政府性基金预算收入([0-9.]+)亿元，完成预算的45.3%",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2024年执行数",
        "document_type": "城市财政预算执行报告（官方网页）",
        "page_number": "网页正文：全市政府性基金预算执行情况",
        "page_count": "1",
        "note": "A2防城港市财政局官方报告；全市政府性基金预算收入为16.32亿元，另列市本级14.06亿元，采用全市口径。",
    },
    {
        "year": 2024,
        "city_name": "钦州市",
        "city_id": "CN-450700",
        "source_doc_id": "SRC-A2-QINZHOU-CITY-FUND-2024",
        "url": "https://czj.qinzhou.gov.cn/zfxxgk/fdzdgknryjsgk/zfys/t19562397.shtml",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "qinzhou_2024_budget_report_snapshot.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "qinzhou_2024_fund_excerpt.txt",
        "text_is_curated": True,
        ...
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"政府性基金预算收入([0-9.]+)亿元，完成预算的57.6%",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2024年执行数",
        "document_type": "城市财政预算执行报告（官方网页）",
        "page_number": "网页正文：全市政府性基金预算执行情况",
        "page_count": "1",
        "note": "A2钦州市财政局官方报告；明确披露全市政府性基金预算收入58.5亿元，另列市本级46.52亿元，采用全市口径。",
    },
    {
        "year": 2025,
        "city_name": "本溪市",
        "city_id": "CN-210500",
        "source_doc_id": "SRC-A2-LIAONING-BENXI-FUND-2025",
        "url": "https://czj.benxi.gov.cn/yjsbg/czyjsbg/content_656950",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "benxi_2025_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "benxi_2025_fund_excerpt.txt",
        "document_title": "关于本溪市2025年预算执行情况和2026年预算草案的报告",
        "publisher": "本溪市财政局",
        "publisher_level": "市级财政机构",
        ...
        "page_number": "网页正文：政府性基金预算执行情况",
        "page_count": "1",
        "note": "A2本溪市财政局官方报告；披露全市政府性基金预算收入合计43604万元，采用全市口径，不使用市本级数。",
    },
    {
        "year": 2025,
        "city_name": "娄底市",
        "city_id": "CN-431300",
        "source_doc_id": "SRC-B1-HUNAN-LOUDI-FUND-2025",
        "url": "https://zt.ldnews.cn/content/202601/748237.shtml",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "loudi_2025_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "loudi_2025_fund_excerpt.txt",
        "document_title": "娄底市第六届人民代表大会财政经济委员会关于2025年全市及市级财政预算执行情况与2026年市级财政预算草案审查结果的报告",
        "publisher": "娄底市人民代表大会财政经济委员会（娄底新闻网转载）",
        "publisher_level": "市级人大报告公开转载",
        "publication_date": "2026-01-16",
        "source_grade": "B1",
        "source_format": "html",
        "pattern": r"政府性基金收入([0-9.]+)亿元",
        ...
        "data_status": "execution",
        "data_status_label": "2025年执行数",
        "document_type": "人大财政经济委员会预算审查报告（公开转载）",
        "page_number": "网页正文：全市财政预算执行情况",
        "page_count": "1",
        "note": "B1公开转载的市人大财政经济委员会报告；原文披露2025年全市政府性基金收入34.54亿元，采用全市口径。",
    },
    {
        "year": 2025,
        "city_name": "湘潭市",
        "city_id": "CN-430300",
        "source_doc_id": "SRC-B1-HUNAN-XIANGTAN-FUND-2025",
        "url": "https://www.sohu.com/a/1056118359_121106908",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "xiangtan_2025_final_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "xiangtan_2025_fund_excerpt.txt",
        "document_title": "2025年度湘潭市本级财政决算报告",
        "publisher": "湘潭市人民政府（市人大常委会批准报告转载）",
        "publisher_level": "市级法定决算报告公开转载",
        ...
        "data_status": "final",
        "data_status_label": "2025年决算数",
        "document_type": "城市财政决算报告（公开转载）",
        "page_number": "网页正文：2025年度决算报告",
        "page_count": "1",
        "note": "B1公开转载的湘潭市法定决算报告；原文披露2025年全市政府性基金预算收入52.6亿元，采用全市口径。",
    },
    {
        "year": 2025,
        "city_name": "濮阳市",
        "city_id": "CN-410900",
        "source_doc_id": "SRC-B2-HENAN-PUYANG-FUND-2025",
        "url": "https://static.sse.com.cn/disclosure/bond/announcement/company/c/new/2026-07-15/242767_20260715_C5OQ.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "puyang_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "puyang_2025_fund_excerpt.txt",
        "document_title": "濮阳市财政收支及债务情况评级报告",
        "publisher": "安融信用评级有限公司（依据濮阳市财政局资料）",
        ...
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2025年执行数（B2整理）",
        "document_type": "评级报告精确表格",
        "page_number": "PDF表2（正文第9页）",
        "page_count": "",
        "note": "B2评级报告精确表格；表格标题为濮阳市财政收支及债务情况，数据来源标注濮阳市财政局，2025年政府性基金收入54.39亿元。",
    },
    {
        "year": 2025,
        "city_name": "绵阳市",
        "city_id": "CN-510700",
        "source_doc_id": "SRC-B2-SICHUAN-MIANYANG-FUND-2025",
        "url": "https://qxb-pdf-osscache.qixin.com/AnBaseinfo/fe8754e5e538d04865570ccd649f9c82.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "mianyang_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "mianyang_2025_fund_excerpt.txt",
        "document_title": "绵阳市财政收支及债务情况评级报告",
        "publisher": "评级机构公开报告（依据绵阳市公开资料）",
        "publisher_level": "评级机构/市级财政数据",
        "publication_date": "2026-06-18",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"2025年政府性基金收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2025年执行数（B2整理）",
        "document_type": "评级报告精确表格",
        "page_number": "PDF：财政收支及债务表",
        "page_count": "",
        "note": "B2评级报告精确表格；表格列示2025年政府性基金收入205.46亿元，采用绵阳市全市口径。",
    },
    {
        "year": 2025,
        "city_name": "眉山市",
        "city_id": "CN-511400",
        "source_doc_id": "SRC-B2-SICHUAN-MEISHAN-FUND-2025",
        "url": "https://static.sse.com.cn/disclosure/bond/announcement/corporate/c/new/2026-06-18/152491_20260618_LBUR.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "meishan_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "meishan_2025_fund_excerpt.txt",
        "document_title": "眉山市财政收支及债务情况评级报告",
        "publisher": "评级机构公开报告（依据眉山市公开资料）",
        "publisher_level": "评级机构/市级财政数据",
        "publication_date": "2026-06-18",
        "source_grade": "B2",
        "source_format": "pdf",
        ...
        "page_number": "PDF：财政收支及债务表",
        "page_count": "",
        "note": "B2评级报告精确表格；表格列示2025年政府性基金收入155.45亿元，采用眉山市全市口径。",
    },
    {
        "year": 2025,
        "city_name": "韶关市",
        "city_id": "CN-440200",
        "source_doc_id": "SRC-A2-GUANGDONG-SHAOGUAN-FUND-2025",
        "url": "https://www.sg.gov.cn/attachment/0/273/273266/2735579.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "shaoguan_2025_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "shaoguan_2025_fund_excerpt.txt",
        "document_title": "韶关市2025年预算草案",
        "publisher": "韶关市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-02-01",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"政府性基金预算收入([0-9,]+)万元",
        "raw_unit": "万元",
        "data_status": "budget",
        "data_status_label": "2025年预算数（非执行数）",
        "document_type": "城市财政预算报告（官方PDF）",
        "page_number": "PDF：全市政府性基金预算表",
        "page_count": "",
        "note": "A2韶关市官方预算PDF；披露2025年政府性基金预算收入安排536525万元，明确为预算数，不冒充执行数。",
    },
    {
        "year": 2025,
        "city_name": "梅州市",
        "city_id": "CN-441400",
        "source_doc_id": "SRC-A2-GUANGDONG-MEIZHOU-FUND-2025",
        "url": "https://www.meizhou.gov.cn/attachment/0/207/207736/2740144.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "meizhou_2025_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "meizhou_2025_fund_excerpt.txt",
        "document_title": "梅州市2025年预算草案",
        "publisher": "梅州市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-02-01",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"2025年全市政府性基金预算收入安排([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年预算数（非执行数）",
        "document_type": "城市财政预算报告（官方PDF）",
        "page_number": "PDF：全市政府性基金预算安排",
        "page_count": "",
        "note": "A2梅州市官方预算PDF；披露2025年全市政府性基金预算收入安排94.64亿元，明确为预算数，不冒充执行数。",
    },
    {
        "year": 2025,
        "city_name": "永州市",
        "city_id": "CN-431100",
        "source_doc_id": "SRC-A2-HUNAN-YONGZHOU-FUND-2025",
        "url": "https://czj.yzcity.gov.cn/czj/030701/202502/fb14524fceb24ad9babf08f05530e20a/files/7158a8cef5a14c64b60a48365ba8e247.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "yongzhou_2025_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "yongzhou_2025_fund_excerpt.txt",
        "document_title": "永州市2025年政府性基金收入预算表",
        "publisher": "永州市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-02-01",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"地方本级收入合计([0-9,]+)万元",
        "raw_unit": "万元",
        "data_status": "budget",
        "data_status_label": "2025年预算数（非执行数）",
        "document_type": "城市财政预算表（官方PDF）",
        "page_number": "PDF：政府性基金收入预算表",
        "page_count": "",
        "note": "A2永州市财政局官方预算表；采用政府性基金收入预算表中的地方本级收入合计1687915万元，明确为预算数，不使用含转移支付等项目的收入总计。",
    },
    {
        "year": 2025,
        "city_name": "黄石市",
        "city_id": "CN-420200",
        "source_doc_id": "SRC-A2-HUBEI-HUANGSHI-FUND-2025",
        "url": "https://czj.huangshi.gov.cn/2020xxgkzn/2020gknr/2020czzj/sbjyjs/202502/t20250225_1197238.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "huangshi_2025_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "huangshi_2025_fund_excerpt.txt",
        "document_title": "表十二 2025年全市政府性基金收入预算表",
        "publisher": "黄石市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-02-25",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"收入合计([0-9,]+)万元",
        "raw_unit": "万元",
        "data_status": "budget",
        "data_status_label": "2025年预算数（非执行数）",
        "document_type": "城市财政预算表（官方网页）",
        "page_number": "网页正文：表十二",
        "page_count": "1",
        "note": "A2黄石市财政局官方预算表；表十二披露全市政府性基金收入预算收入合计1246318万元，明确为预算数，不冒充执行数。",
    },
)
# 本批补录：晋中市评级报告表2给出2023、2025年全市政府性基金收入；
# 运城市政府预算报告给出2025年全市政府性基金预算收入。三项均为可定位的
# 精确表格/正文值，晋中按B2、运城按B1登记；不使用市本级或县区口径替代全市。
CITY_YEAR_FUND_SOURCES += (
    {
        "year": 2023,
        "city_name": "晋中市",
        "city_id": "CN-140700",
        "source_doc_id": "SRC-B2-SHANXI-JINZHONG-FUND-2023",
        "url": "https://static.sse.com.cn/disclosure/bond/announcement/company/c/new/2026-06-26/185464_20260626_LE45.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "jinzhong_2023_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "jinzhong_2023_fund_excerpt.txt",
        "document_title": "晋中公投主体与相关债项2026年度跟踪评级报告",
        "publisher": "公开评级报告",
        "publisher_level": "评级机构研究报告",
        "publication_date": "2026-06-26",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"2023年政府性基金收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2023年全市政府性基金收入执行数",
        "document_type": "评级报告精确表格",
        "page_count": "表2（正文第8页）",
        "note": "B2精确表2；报告列示晋中市2023年全市政府性基金收入30.14亿元，行政范围与年度明确，不使用市本级数。",
    },
    {
        "year": 2025,
        "city_name": "晋中市",
        "city_id": "CN-140700",
        "source_doc_id": "SRC-B2-SHANXI-JINZHONG-FUND-2025",
        "url": "https://static.sse.com.cn/disclosure/bond/announcement/company/c/new/2026-06-26/185464_20260626_LE45.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "jinzhong_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "jinzhong_2025_fund_excerpt.txt",
        "document_title": "晋中公投主体与相关债项2026年度跟踪评级报告",
        "publisher": "公开评级报告",
        "publisher_level": "评级机构研究报告",
        "publication_date": "2026-06-26",
        ...
        "document_type": "评级报告精确表格",
        "page_count": "表2（正文第8页）",
        "note": "B2精确表2；报告列示晋中市2025年全市政府性基金收入19.81亿元，行政范围与年度明确，不使用市本级数。",
    },
    {
        "year": 2025,
        "city_name": "运城市",
        "city_id": "CN-140800",
        "source_doc_id": "SRC-B1-SHANXI-YUNCHENG-FUND-2025",
        "url": "https://www.yuncheng.gov.cn/uploadfiles/202603/27/2026032709294953644166.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "yuncheng_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "yuncheng_2025_fund_excerpt.txt",
        ...
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金预算收入预算数",
        "document_type": "城市财政预算报告（官方PDF）",
        "page_count": "正文财政段",
        "note": "B1官方预算报告；正文明确列示运城市2025年全市政府性基金预算收入65.86亿元，登记为预算数，不冒充执行数；不使用市本级数。",
    },
    {
        "year": 2025,
        "city_name": "阳泉市",
        "city_id": "CN-140300",
        "source_doc_id": "SRC-A2-SHANXI-YANGQUAN-FUND-2025",
        "url": "https://czj.yq.gov.cn/yjsgk/zfyjs/zfjs/jsgk2024/202509/P020250917362856003440.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "yangquan_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "yangquan_2025_fund_excerpt.txt",
        "document_title": "关于阳泉市2024年全市和市级预算执行情况与2025年全市和市级预算草案的报告",
        "publisher": "阳泉市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-09-16",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"2025年全市政府性基金预算预期收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金预算预期收入",
        "document_type": "城市财政预算报告（官方PDF）",
        "page_count": "PDF第20页",
        "note": "A2阳泉市财政局官方预算报告；正文明确列示2025年全市政府性基金预算预期收入24.78亿元，登记为预算数，不冒充执行数；不使用市本级数。",
    },
    {
        "year": 2025,
        "city_name": "牡丹江市",
        "city_id": "CN-231000",
        "source_doc_id": "SRC-A2-HEILONGJIANG-MUDANJIANG-FUND-2025",
        "url": "https://www.mdj.gov.cn/mdjsrmzf/szfys2025/202501/992844/files/%E9%99%84%E4%BB%B61%EF%BC%9A2025%E5%B9%B4%E9%A2%84%E7%AE%97%E5%85%AC%E5%BC%80%E8%A1%A8.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "mudanjiang_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "mudanjiang_2025_fund_excerpt.txt",
        "document_title": "牡丹江市2025年预算公开表（附件一）",
        "publisher": "牡丹江市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-01-01",
        "source_grade": "A2",
        ...
        "raw_unit": "万元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金收入预算数",
        "document_type": "城市财政预算表（官方PDF）",
        "page_count": "附件一相关表格",
        "note": "A2牡丹江市财政局官方预算表；全市政府性基金预算收入表列示收入合计265197万元，换算为26.5197亿元；登记为预算数，不冒充执行数。",
    },
    {
        "year": 2025,
        "city_name": "黄山市",
        "city_id": "CN-341000",
        "source_doc_id": "SRC-A2-ANHUI-HUANGSHAN-FUND-2025",
        "url": "https://www.huangshan.gov.cn/zxzx/zwyw/8418773.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "huangshan_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "huangshan_2025_fund_excerpt.txt",
        ...
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2025年全市政府性基金预算收入执行数",
        "document_type": "城市财政预算执行报告摘要（官方网页）",
        "page_count": "网页正文",
        "note": "A2黄山市人民政府官方报告摘要；正文明确列示2025年全市政府性基金预算收入完成40.6亿元，采用全市执行口径，不使用市本级数。",
    },
    {
        "year": 2025,
        "city_name": "吴忠市",
        "city_id": "CN-640300",
        "source_doc_id": "SRC-A2-NINGXIA-WUZHONG-FUND-2025",
        "url": "https://www.wuzhong.gov.cn/xxgk/zfxxgkml/yjsgkqk/zfys/2026n/202602/P020260204632187152760.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "wuzhong_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "wuzhong_2025_fund_excerpt.txt",
        "document_title": "2025年全市及市本级政府性基金预算执行情况和2026年全市及市本级政府性基金预算草案",
        "publisher": "吴忠市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2026-02-04",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"2025年全市政府性基金收入完成([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2025年全市政府性基金收入执行数",
        "document_type": "城市财政预算执行表（官方PDF）",
        "page_count": "PDF相关表格",
        "note": "A2吴忠市财政局官方全市执行表；全市政府性基金收入完成207123万元，换算为20.7123亿元；不使用市本级83522万元。",
    },
    {
        "year": 2025,
        "city_name": "宜昌市",
        "city_id": "CN-420500",
        "source_doc_id": "SRC-A2-HUBEI-YICHANG-FUND-2025",
        "url": "https://www.yc.gov.cn/ycsrmzf/c102038/202501/390493/files/2025%E5%B9%B4%E6%94%BF%E5%BA%9C%E9%A2%84%E7%AE%97%E8%A1%A8.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "yichang_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "yichang_2025_fund_excerpt.txt",
        "document_title": "2025年全市及市本级政府性基金预算收支平衡表",
        "publisher": "宜昌市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-01-01",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"本年收入[^0-9]*([0-9]+)",
        "raw_unit": "万元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金预算收入预算数",
        "document_type": "城市财政预算表（官方PDF）",
        "page_number": "2025年全市及市本级政府性基金预算收支平衡表",
        "page_count": "1",
        "note": "A2宜昌市财政局官方预算表；全市本年收入150408万元，合计157507万元含转移性收入，采用本年收入并换算为15.0408亿元；不使用市本级99118万元。",
    },
    {
        "year": 2025,
        "city_name": "儋州市",
        "city_id": "CN-460400",
        "source_doc_id": "SRC-A2-Hainan-DANZHOU-FUND-2025",
        "url": "https://download.s21i.co99.net/15207832/0/2/ABUIABA9GAAg46fVyAYo7Or2kAE.pdf?f=2025%E5%B9%B4%E5%84%8B%E5%B7%9E%E5%B8%82%E9%A2%84%E7%AE%97%E8%B0%83%E6%95%B4%E6%96%B9%E6%A1%88.pdf&v=1763005411",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "danzhou_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "danzhou_2025_fund_excerpt.txt",
        "document_title": "儋州市财政局关于提请市政府常务会审议2025年预算调整方案（送审稿）的请示",
        "publisher": "儋州市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-11-13",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"地方政府性基金预算收入([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年预算调整数",
        "document_type": "城市财政预算调整文件（官方PDF）",
        "page_number": "正文：政府性基金预算调整情况",
        "page_count": "1",
        "note": "A2儋州市财政局预算调整文件；明确列示2025年地方政府性基金预算收入18.71亿元，债务转贷收入和转移性收入另列，不使用总收入口径。",
    },
    {
        "year": 2025,
        "city_name": "揭阳市",
        "city_id": "CN-445200",
        "source_doc_id": "SRC-A2-GUANGDONG-JIEYANG-FUND-2025",
        "url": "https://www.jieyang.gov.cn/jyczj/attachment/0/167/167560/931321.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "jieyang_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "jieyang_2025_fund_excerpt.txt",
        "document_title": "2025年揭阳市本级政府预算公开",
        "publisher": "揭阳市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-01-01",
        "source_grade": "A2",
        ...
        "page_number": "正文第21页",
        "page_count": "1",
        "note": "A2揭阳市财政局官方预算公开；明确披露全市政府性基金预算收入预计73.77亿元，另列市级41.32亿元，采用全市口径。",
    },
    {
        "year": 2025,
        "city_name": "潮州市",
        "city_id": "CN-445100",
        "source_doc_id": "SRC-A2-GUANGDONG-CHAOZHOU-FUND-2025",
        "url": "https://www.chaozhou.gov.cn/attachment/0/553/553564/3938394.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "chaozhou_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "chaozhou_2025_fund_excerpt.txt",
        "document_title": "2025年潮州市本级政府预算公开",
        "publisher": "潮州市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-01-01",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"全市政府性基金预算收入预计完成([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金预算收入预算数",
        "document_type": "城市财政预算报告（官方PDF）",
        "page_number": "正文第17页",
        "page_count": "1",
        "note": "A2潮州市财政局官方预算公开；明确披露全市政府性基金预算收入预计完成314103万元，另列市本级169962万元，采用全市口径。",
    },
    {
        "year": 2025,
        "city_name": "清远市",
        "city_id": "CN-441800",
        "source_doc_id": "SRC-A2-GUANGDONG-QINGYUAN-FUND-2025",
        "url": "https://www.gdqy.gov.cn/qyczj/attachment/0/176/176060/1991317.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "qingyuan_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "qingyuan_2025_fund_excerpt.txt",
        "document_title": "2025年清远市本级政府预算公开",
        "publisher": "清远市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-11-01",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"全市政府性基金预算收入计划安排([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金预算收入预算数",
        "document_type": "城市财政预算报告（官方PDF）",
        "page_number": "正文第13页",
        "page_count": "1",
        "note": "A2清远市财政局官方预算公开；明确披露全市政府性基金预算收入计划安排130.09亿元，采用全市代编预算口径。",
    },
    {
        "year": 2025,
        "city_name": "榆林市",
        "city_id": "CN-610800",
        "source_doc_id": "SRC-A1-SHAANXI-YULIN-FUND-2025",
        "url": "https://www.yl.gov.cn/zwgk/fdzdgknr/czxx/czyjs/szfczys/202603/t20260319_2082424.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "ylin_2025_budget_execution_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "ylin_2025_budget_execution_excerpt.txt",
        ...
        "source_grade": "A1",
        "source_format": "pdf",
        "pattern": r"政府性基金收入=([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2025年全市政府性基金收入执行数",
        "document_type": "市级财政预算执行报告",
        "page_number": "PDF第38页表十六；全市口径；政府性基金收入合计行",
        "page_count": "62",
        "note": "A1榆林市财政局官方预算执行报告；表十六列示2025年全市政府性基金收入执行数672922万元，换算为67.29亿元；不使用市级表。",
    },
)

# 本批补录：评级报告中的精确城市财政表。表格明确列示全市行政范围，
# 但资料由评级机构根据公开资料整理，因此按 B2 登记，不把评级报告当作 A1/A2。
CITY_YEAR_FUND_SOURCES += (
    {
        "year": 2025,
        "city_name": "长春市",
        "city_id": "CN-220100",
        "source_doc_id": "SRC-B2-CHANGCHUN-CITY-FUND-2025",
        "url": "https://static.cninfo.com.cn/finalpage/2026-06-22/1225380298.PDF",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "changchun_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "changchun_2025_fund_excerpt.txt",
        "document_title": "长春新区发展集团有限公司2026年度跟踪评级报告",
        "publisher": "东方金诚国际信用评估有限公司",
        "publisher_level": "评级机构（精确表格）",
        "publication_date": "2026-06-17",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"长春市\|2025年\|政府性基金收入（亿元）\|([0-9.]+)",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2025年全市政府性基金收入执行数（B2精确表格）",
        "document_type": "城市经济财政评级报告（精确表格）",
        "page_number": "PDF第4页、第24页；地区经济及财政表/图表19",
        "page_count": "34",
        "note": "B2精确表格；报告明确列示长春市2025年政府性基金收入281.93亿元，城市范围为长春市；资料来源注明为长春市2023—2025年统计公报、2023—2024年财政决算情况及2025年财政预算情况，东方金诚整理；与主表既有2023、2024口径一致。",
    },
    {
        "year": 2022,
        "city_name": "南宁市",
        "city_id": "CN-450100",
        "source_doc_id": "SRC-B2-NANNING-CITY-FUND-2022",
        "url": "https://www.chinamoney.org.cn/dqs/cm-s-notice-query/fileDownLoad.do?contentId=3305235&mode=save&priority=0",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "nanning_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "nanning_city_fund_excerpt.txt",
        "document_title": "广西绿城水务集团股份有限公司主体长期信用评级报告",
        "publisher": "联合资信评估股份有限公司",
        "publisher_level": "评级机构（精确表格）",
        "publication_date": "2026-02-27",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"南宁市\|2022年\|政府性基金收入（亿元）\|([0-9.]+)",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2022年全市政府性基金收入执行数（B2精确表格）",
        "document_type": "城市经济财政评级报告（精确表格）",
        "page_number": "PDF第10页；图表3",
        "page_count": "30",
        "note": "B2精确表格；报告图表3明确列示南宁市2022年政府性基金收入234.08亿元，城市范围为南宁市；资料来源为联合资信根据公开资料整理；与主表既有2024年全市值150.59亿元口径一致。",
    },
    {
        "year": 2023,
        "city_name": "南宁市",
        "city_id": "CN-450100",
        "source_doc_id": "SRC-B2-NANNING-CITY-FUND-2023",
        "url": "https://www.chinamoney.org.cn/dqs/cm-s-notice-query/fileDownLoad.do?contentId=3305235&mode=save&priority=0",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "nanning_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "nanning_city_fund_excerpt.txt",
        "document_title": "广西绿城水务集团股份有限公司主体长期信用评级报告",
        ...
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"南宁市\|2023年\|政府性基金收入（亿元）\|([0-9.]+)",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2023年全市政府性基金收入执行数（B2精确表格）",
        "document_type": "城市经济财政评级报告（精确表格）",
        "page_number": "PDF第10页；图表3",
        "page_count": "30",
        "note": "B2精确表格；报告图表3明确列示南宁市2023年政府性基金收入207.51亿元，城市范围为南宁市；资料来源为联合资信根据公开资料整理；与主表既有2024年全市值150.59亿元口径一致。",
    },
)
# 本批补录：通辽、鄂尔多斯、信阳 2025 年全市政府性基金收入。
# 通辽、信阳为官方预算数，鄂尔多斯为财政部门年度执行数，均保留原始状态。
CITY_YEAR_FUND_SOURCES += (
    {
        "year": 2025,
        "city_name": "通辽市",
        "city_id": "CN-150500",
        "source_doc_id": "SRC-A2-INNER-MONGOLIA-TONGLIAO-FUND-2025",
        "url": "https://czj.tongliao.gov.cn/zwgk/zfxxgk/fdzdgknr/czyjsgkk/zfys/202504/P020250411386967825754.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "tongliao_2025_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "tongliao_2025_fund_excerpt.txt",
        "document_title": "通辽市政府2025年度预算",
        "publisher": "通辽市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-04-11",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"通辽市\|2025年\|政府性基金收入（亿元）\|([0-9.]+)",
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金收入预算数",
        "document_type": "城市财政预算报告（官方PDF）",
        "page_number": "PDF第13页；政府性基金预算",
        "page_count": "24",
        "note": "A2通辽市财政局官方预算报告；第13页明确列示2025年全市政府性基金预算总收入预计131.41亿元，其中政府性基金收入69.48亿元；主表采用政府性基金收入本级项目值，不使用含上年结转的收入总计。",
    },
    {
        "year": 2025,
        "city_name": "鄂尔多斯市",
        "city_id": "CN-150600",
        "source_doc_id": "SRC-A1-INNER-MONGOLIA-ORDOS-FUND-2025",
        "url": "https://czj.ordos.gov.cn/xxgk/fdzdgk/czsj/202603/t20260324_3883585.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "ordos_2025_fiscal_execution.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "ordos_2025_fund_excerpt.txt",
        "document_title": "鄂尔多斯市2025年1-12月全市财政收支情况",
        "publisher": "鄂尔多斯市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-12-17",
        "source_grade": "A1",
        "source_format": "html",
        "pattern": r"鄂尔多斯市\|2025年\|政府性基金收入（亿元）\|([0-9.]+)",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2025年全市政府性基金收入执行数",
        "document_type": "城市财政月度累计执行报告（官方网页）",
        "page_number": "网页正文；截至12月底",
        "page_count": "1",
        "note": "A1鄂尔多斯市财政局官方网页；正文明确披露截至2025年12月底全市政府性基金预算收入完成97.4亿元，采用全市累计执行口径。",
    },
    {
        "year": 2025,
        "city_name": "信阳市",
        "city_id": "CN-411500",
        "source_doc_id": "SRC-A2-HENAN-XINYANG-FUND-2025",
        "url": "https://oss.xinyang.gov.cn/xytyptfile/20250228/f1ec7cf205a644aeb0dc4fb2a702d312.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "xinyang_2025_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "xinyang_2025_fund_excerpt.txt",
        "document_title": "关于信阳市2024年财政预算执行情况和2025年财政预算",
        "publisher": "信阳市人民政府、信阳市财政局",
        "publisher_level": "市级人大预算文件",
        "publication_date": "2025-02-28",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"信阳市\|2025年\|政府性基金收入（亿元）\|([0-9.]+)",
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金收入预算数",
        "document_type": "城市财政预算报告（官方PDF摘录）",
        "page_number": "PDF第12页；代编全市政府性基金预算",
        "page_count": "正文及附表",
...
# 贵港市 2025 年政府性基金收入精确表格补缺。
# 东方金诚公开跟踪评级报告的图表 12 逐年列示 2023—2025 年贵港市全市
# 政府性基金收入，报告注明资料来自 2023—2025 年财政预算执行资料；本批只
# 接入 2025 年主表空值，不使用市本级数或图表估读。
GUIGANG_2025_FUND_SOURCE = {
    "year": 2025,
    "city_name": "贵港市",
    "city_id": "CN-450800",
    "source_doc_id": "SRC-B2-GUANGXI-2025-FUND-CN-450800",
    ...
    "source_grade": "B2",
    "source_format": "pdf",
    "pattern": r"政府性基金收入\|40\.54\|29\.52\|([0-9.]+)",
    "raw_unit": "亿元",
    "data_status": "execution",
    ...
    "note": (
        "B2精确表格；图表12明确列示贵港市全市2025年政府性基金收入18.22亿元，"
...
QINZHOU_2025_FUND_SOURCE = {
    "year": 2025,
    "city_name": "钦州市",
    "city_id": "CN-450700",
    "source_doc_id": "SRC-B2-GUANGXI-2025-FUND-CN-450700",
    "url": "https://www.chinamoney.org.cn/dqs/cm-s-notice-query/fileDownLoad.do?contentId=3363662&mode=save&priority=0",
    "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "qinzhou_2025_dongfang_peer_report.pdf",
    "text_path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "qinzhou_2025_dongfang_peer_excerpt.txt",
    "document_title": "景德镇市城市建设投资集团有限责任公司主体及相关债项2026年度跟踪评级报告",
    "publisher": "东方金诚国际信用评估有限公司（中国货币网公开披露）",
    "publisher_level": "评级机构公开披露的精确表格二手来源",
    "publication_date": "2026-06-18",
    "source_grade": "B2",
    "source_format": "pdf",
    "pattern": r"政府性基金收入（亿元）\|172\.69\|([0-9.]+)\|17\.39\|343\.30",
    "raw_unit": "亿元",
    "data_status": "reported",
    "data_status_label": "2025年公开精确值",
    "document_type": "评级报告地级市经济财政指标表",
    "page_count": "PDF第3页（同业比较表）",
    "note": (
        "B2精确表格；同业比较表明确列示钦州市全市2025年政府性基金收入65.00亿元，"
        "并注明表中数据年份为2025年、经济财政数据来自各地政府官网公开统计公报和预决算报告；"
        "不使用图表估读、市本级或区县数。"
    ),
}
...
# 新疆哈密市、巴音郭楞州、克孜勒苏州 2025 年全市/全州政府性基金预算收入。
# 三份材料均为财政预算公开，不把预算安排数伪装为年末决算执行数。
CITY_YEAR_FUND_SOURCES += (
    {
        "year": 2025,
        "city_name": "哈密市",
        "city_id": "CN-650500",
        "source_doc_id": "SRC-A2-XINJIANG-HAMI-FUND-BUDGET-2025",
        "url": "https://www.hami.gov.cn/hami/c120048/202504/89bacfe4b995499b9d821f1c688c5949.shtml",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "hami_2025_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "hami_2025_fund_excerpt.txt",
        "document_title": "2025年哈密市政府预算公开",
        "publisher": "哈密市财政局、哈密市人民政府",
        "publisher_level": "市级财政机构及市政府官网",
        "publication_date": "2025-03-05",
        "source_grade": "A2",
        "source_format": "html",
        "pattern": r"政府性基金预算收入预计([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年全市政府性基金预算安排数",
        "document_type": "市级政府预算公开网页",
        "page_number": "网页正文政府性基金预算草案及表9《2025年哈密市政府性基金收入表》",
        "note": "A2市政府官网预算公开；全市政府性基金预算收入预计26.26亿元，表9收入合计262581万元相互印证；不使用市本级14.76亿元，不将预算数表述为决算执行数。",
    },
    {
        "year": 2025,
        "city_name": "巴音郭楞蒙古自治州",
        "city_id": "CN-652800",
        "source_doc_id": "SRC-A2-XINJIANG-BAZHOU-FUND-BUDGET-2025",
        "url": "https://www.xjbz.gov.cn/xjbz/c124598/202503/6db74f6ec2b242828e671ba29af8cc94/files/2024%E5%B9%B4%E8%87%AA%E6%B2%BB%E5%B7%9E%E9%A2%84%E7%AE%97%E6%89%A7%E8%A1%8C%E6%83%85%E5%86%B5%E4%B8%8E2025%E5%B9%B4%E8%87%AA%E6%B2%BB%E5%B7%9E%E9%A2%84%E7%AE%97%E8%8D%89%E6%A1%88%E7%9A%84%E6%8A%A5%E5%91%8A%EF%BC%88%E5%8D%81%E4%BA%94%E5%B1%8A%E5%9B%9B%E6%AC%A1%EF%BC%89.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "bazhou_2025_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "bazhou_2025_fund_excerpt.txt",
        "document_title": "2024年自治州预算执行情况与2025年自治州预算草案的报告",
        "publisher": "巴音郭楞蒙古自治州财政局、自治州人民政府",
        "publisher_level": "自治州财政机构及州政府官网",
        "publication_date": "2025-03-01",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"2025年，全州政府性基金预算收入预计([0-9,]+)万元",
        "raw_unit": "万元",
        "data_status": "budget",
        "data_status_label": "2025年全州政府性基金预算预计数",
        "document_type": "自治州政府预算公开PDF",
        "page_number": "PDF正文政府性基金预算草案段落",
        "note": "A2自治州政府官网财政预算公开PDF；正文明确列示2025年全州政府性基金预算收入预计368654万元，原始单位万元，换算为36.87亿元；不使用州本级口径。",
    },
    {
        "year": 2025,
        "city_name": "克孜勒苏柯尔克孜自治州",
        "city_id": "CN-653000",
        "source_doc_id": "SRC-A2-XINJIANG-KIZILSU-FUND-BUDGET-2025",
        "url": "https://www.xjkz.gov.cn/xjkz/c124240/202502/e8665a0ea64d42d7acb34309aa55e83d/files/%E5%85%8B%E5%B7%9E2025%E5%B9%B4%E6%94%BF%E5%BA%9C%E9%A2%84%E7%AE%97%E5%85%AC%E5%BC%80-20250717192026427.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "kizilsu_2025_budget_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "kizilsu_2025_fund_excerpt.txt",
        "document_title": "克州2025年政府预算公开",
        "publisher": "克孜勒苏柯尔克孜自治州财政局、自治州人民政府",
        "publisher_level": "自治州财政机构及州政府官网",
        "publication_date": "2025-02-01",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"全州政府性基金预算收入安排([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "budget",
        "data_status_label": "2025年全州政府性基金预算安排数",
        "document_type": "自治州政府预算公开PDF",
    ...
    },
    {
        ...
        "city_name": "伊犁哈萨克自治州",
        "city_id": "CN-654000",
        "source_doc_id": "SRC-A2-XINJIANG-ILI-FUND-BUDGET-2025",
        "url": "https://www.xjyl.gov.cn/xjylz/c125503/202503/a308a90ad63248548f4dad27a7bfc16f.shtml",
        "attachment_url": "https://www.xjyl.gov.cn/xjylz/c125503/202503/a308a90ad63248548f4dad27a7bfc16f/images/20260202100848426008.png",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "ili_2025_fund_table_page86.png",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "ili_2025_fund_excerpt.txt",
        "document_title": "伊犁哈萨克自治州2025年政府预算公开",
        "publisher": "伊犁州财政局、伊犁哈萨克自治州人民政府",
        "publisher_level": "自治州财政机构及州政府官网",
        ...
        "data_status": "budget",
        "data_status_label": "2025年全州政府性基金预算安排数",
        "document_type": "自治州政府预算公开官方表页图片",
        "page_number": "官方网页正文第86页表9《2025年伊犁州政府性基金收入表》",
...
# 本批补录：公开评级报告精确列示绵阳、眉山历史全市基金收入，
# 以及湘西州官方预算执行报告列示的2024年全州基金收入。均保留执行数状态，
# 不以预算预计数替代执行数。
CITY_YEAR_FUND_SOURCES += (
    {
        "year": 2023,
        "city_name": "绵阳市",
        "city_id": "CN-510700",
        "source_doc_id": "SRC-B2-SICHUAN-MIANYANG-FUND-2023",
        "url": "https://qxb-pdf-osscache.qixin.com/AnBaseinfo/fe8754e5e538d04865570ccd649f9c82.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "mianyang_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "mianyang_2025_fund_excerpt.txt",
        "text_is_curated": True,
        ...
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"、2023年([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2023年执行数（B2整理）",
        "document_type": "评级报告精确表格",
        "page_number": "PDF：财政收支及债务表",
        "page_count": "",
        "note": "B2评级报告精确表格；表格列示2023年政府性基金收入192.62亿元，采用绵阳市全市口径。",
    },
    {
        "year": 2024,
        "city_name": "绵阳市",
        "city_id": "CN-510700",
        "source_doc_id": "SRC-B2-SICHUAN-MIANYANG-FUND-2024",
        "url": "https://qxb-pdf-osscache.qixin.com/AnBaseinfo/fe8754e5e538d04865570ccd649f9c82.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "mianyang_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "mianyang_2025_fund_excerpt.txt",
        "text_is_curated": True,
        ...
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"表格列示2024年([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2024年执行数（B2整理）",
        "document_type": "评级报告精确表格",
        "page_number": "PDF：财政收支及债务表",
        "page_count": "",
        "note": "B2评级报告精确表格；表格列示2024年政府性基金收入206.01亿元，采用绵阳市全市口径。",
    },
    {
        "year": 2024,
        "city_name": "眉山市",
        "city_id": "CN-511400",
        "source_doc_id": "SRC-B2-SICHUAN-MEISHAN-FUND-2024",
        "url": "https://static.sse.com.cn/disclosure/bond/announcement/corporate/c/new/2026-06-18/152491_20260618_LBUR.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "meishan_2025_rating_report.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "meishan_2025_fund_excerpt.txt",
        "text_is_curated": True,
        ...
        "page_number": "PDF：财政收支及债务表",
        "page_count": "",
        "note": "B2评级报告精确表格；表格列示2024年政府性基金收入170.87亿元，采用眉山市全市口径。",
    },
    {
        "year": 2024,
        "city_name": "湘西土家族苗族自治州",
        "city_id": "CN-433100",
        "source_doc_id": "SRC-B2-HUNAN-XIANGXI-FUND-EXECUTION-2024",
        "url": "https://xxgxq.xxz.gov.cn/zwgk/fdzdgknr/czxx/202505/t20250506_2253084.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "xiangxi_2025_budget_report.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "xiangxi_2025_budget_report.html",
        "document_title": "关于湘西州2024年预算执行情况和2025年预算草案的报告",
        "publisher": "湘西土家族苗族自治州财政局（政府官网转载）",
        "publisher_level": "自治州财政机构及州政府官网",
        "publication_date": "2025-03-20",
        "source_grade": "B2",
        "source_format": "html",
        "pattern": r"全州政府性基金预算收入完成([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2024年全州执行数",
        "document_type": "自治州预算执行报告官方网页转载",
        "page_number": "网页正文：第一部分（一）预算执行总体情况",
        "page_count": "1",
        "note": "B2官方网页转载的州财政局预算执行报告；明确列示2024年全州政府性基金预算收入15.2亿元，采用全州口径，不使用州本级数。",
    },
)

# 本批补录：新世纪评级《湖北省及下辖各州市经济财政实力与债务研究（2024）》
# PDF第25页正文逐项明确列示2023年湖北各市/州全市政府性基金预算收入。原报告
# 同时含图表，但本批只采用正文明确写出的精确值，不根据图表目测或媒体转述补值。
HUBEI_2023_LHRATINGS_FUND_SOURCES = (
    {
        "year": 2023,
        "city_name": "十堰市",
        "city_id": "CN-420300",
        "source_doc_id": "SRC-B2-HUBEI-SHIYAN-FUND-2023-LRATINGS",
        "url": "https://pdf.dfcfw.com/pdf/H3_AP202411221641021462_1.pdf?1732286773000.pdf=",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "湖北省及下辖各州市经济财政实力与债务研究（2024）",
        "publisher": "新世纪评级（依据湖北各地市财政决算资料）",
        "publisher_level": "评级机构/地市财政数据",
        "publication_date": "2024-11-21",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"十堰市｜2023年｜([0-9.]+)",
        "raw_unit": "亿元",
        "data_status": "execution",
        ...
        "page_number": "PDF第25页",
        "page_count": "",
        "note": "B2评级报告第25页正文精确列示；十堰市2023年全市政府性基金预算收入92.96亿元，采用全市口径。",
    },
    {
        "year": 2023,
        "city_name": "鄂州市",
        "city_id": "CN-420700",
        "source_doc_id": "SRC-B2-HUBEI-EZHOU-FUND-2023-LRATINGS",
        "url": "https://pdf.dfcfw.com/pdf/H3_AP202411221641021462_1.pdf?1732286773000.pdf=",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_is_curated": True,
        ...
        "page_number": "PDF第25页",
        "page_count": "",
        "note": "B2评级报告第25页正文精确列示；鄂州市2023年全市政府性基金预算收入79.78亿元，采用全市口径。",
    },
    {
        "year": 2023,
        "city_name": "孝感市",
        "city_id": "CN-420900",
        "source_doc_id": "SRC-B2-HUBEI-XIAOGAN-FUND-2023-LRATINGS",
        "url": "https://pdf.dfcfw.com/pdf/H3_AP202411221641021462_1.pdf?1732286773000.pdf=",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_is_curated": True,
        ...
        "page_number": "PDF第25页",
        "page_count": "",
        "note": "B2评级报告第25页正文精确列示；孝感市2023年全市政府性基金预算收入97.05亿元，采用全市口径。",
    },
    {
        "year": 2023,
        "city_name": "荆州市",
        "city_id": "CN-421000",
        "source_doc_id": "SRC-B2-HUBEI-JINGZHOU-FUND-2023-LRATINGS",
        "url": "https://pdf.dfcfw.com/pdf/H3_AP202411221641021462_1.pdf?1732286773000.pdf=",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_is_curated": True,
        ...
        "page_number": "PDF第25页",
        "page_count": "",
        "note": "B2评级报告第25页正文精确列示；荆州市2023年全市政府性基金预算收入164.00亿元，采用全市口径。",
    },
    {
        "year": 2023,
        "city_name": "黄冈市",
        "city_id": "CN-421100",
        "source_doc_id": "SRC-B2-HUBEI-HUANGGANG-FUND-2023-LRATINGS",
        "url": "https://pdf.dfcfw.com/pdf/H3_AP202411221641021462_1.pdf?1732286773000.pdf=",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_is_curated": True,
        ...
        "page_number": "PDF第25页",
        "page_count": "",
        "note": "B2评级报告第25页正文精确列示；黄冈市2023年全市政府性基金预算收入79.04亿元，采用全市口径。",
    },
    {
        "year": 2023,
        "city_name": "咸宁市",
        "city_id": "CN-421200",
        "source_doc_id": "SRC-B2-HUBEI-XIANNING-FUND-2023-LRATINGS",
        "url": "https://pdf.dfcfw.com/pdf/H3_AP202411221641021462_1.pdf?1732286773000.pdf=",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_is_curated": True,
        ...
        "page_number": "PDF第25页",
        "page_count": "",
        "note": "B2评级报告第25页正文精确列示；咸宁市2023年全市政府性基金预算收入81.31亿元，采用全市口径。",
    },
    {
        "year": 2023,
        "city_name": "随州市",
        "city_id": "CN-421300",
        "source_doc_id": "SRC-B2-HUBEI-SUIZHOU-FUND-2023-LRATINGS",
        "url": "https://pdf.dfcfw.com/pdf/H3_AP202411221641021462_1.pdf?1732286773000.pdf=",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hubei_2023_lhratings_fund_exact_excerpt.txt",
        "text_is_curated": True,
        ...
        "page_number": "PDF第25页",
        "page_count": "",
        "note": "B2评级报告第25页正文精确列示；随州市2023年全市政府性基金预算收入32.75亿元，采用全市口径。",
    },
)
...
# 本批补录：湖北、四川、安徽、湖南 2023 年全市/全州政府性基金收入。
# 仅接入能够在官方页面、官方报告或 B2 精确表格/正文中定位到数值的记录；
# 不使用市本级数、图表估读、同比倒算或无法确认行政范围的转述。
CITY_YEAR_FUND_SOURCES += (
    {
        "year": 2023,
        "city_name": "武汉市",
        "city_id": "CN-420100",
        "source_doc_id": "SRC-A1-WUHAN-CITY-FUND-2023",
        "url": "https://czj.wuhan.gov.cn/FBJD/XXGKML/CZGK/CZYJS/202402/t20240202_2355698.html",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hubei_2023_city_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hubei_2023_city_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "武汉市2023年全市政府性基金收入执行情况表",
        "publisher": "武汉市财政局",
        "publisher_level": "市级财政部门官网",
        "publication_date": "2024-02-02",
        "source_grade": "A1",
        "source_format": "html",
        "pattern": r"武汉市2023年全市政府性基金收入执行数=([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "execution",
        "data_status_label": "2023年全市政府性基金收入执行数",
        "document_type": "官方全市政府性基金预算收入执行表",
        "page_count": "1",
        "note": "A1武汉市财政局官方入口页及附件；全市口径，12887659万元，折算为1288.77亿元；不使用市本级数。",
    },
    {
        "year": 2023,
        "city_name": "黄石市",
        "city_id": "CN-420200",
        "source_doc_id": "SRC-A1-HUANGSHI-CITY-FUND-2023",
        "url": "https://czj.huangshi.gov.cn/2020xxgkzn/2020gknr/2020czzj/sbjyjs/202410/t20241025_1160715.html",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hubei_2023_city_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hubei_2023_city_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "表十2023年全市政府性基金收入决算表",
        "publisher": "黄石市财政局",
        "publisher_level": "市级财政部门官网",
        "publication_date": "2024-09-14",
        "source_grade": "A1",
        "source_format": "html",
        "pattern": r"黄石市2023年全市政府性基金收入决算数=([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "reported",
        "data_status_label": "2023年全市政府性基金收入决算数",
        "document_type": "官方全市政府性基金收入决算表",
        "page_count": "1",
        "note": "A1黄石市财政局官方决算表页面；全市口径，1110175万元，折算为111.02亿元；不使用市本级数。",
    },
    {
        "year": 2023,
        "city_name": "宜昌市",
        "city_id": "CN-420500",
        "source_doc_id": "SRC-B2-YICHANG-CITY-FUND-2023",
        "url": "https://static.sse.com.cn/disclosure/bond/announcement/corporate/c/new/2025-06-24/127574_20250624_FMZY.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hubei_2023_city_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hubei_2023_city_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "宜昌市政府公开财政决算数据（评级报告精确引用）",
        "publisher": "宜昌市人民政府公开资料（经交易所公开评级报告精确引用）",
        "publisher_level": "市级政府公开资料/评级报告",
        "publication_date": "2025-06-24",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"宜昌市2023年全市政府性基金收入决算数=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "reported",
        "data_status_label": "2023年全市政府性基金收入决算数",
        "document_type": "评级报告精确引用的官方财政决算数据",
        "page_count": "",
        "note": "B2精确引用；公开报告明确引用宜昌市政府关于2023年市级财政决算的报告，并给出全市政府性基金收入决算数242.51亿元；不使用市本级123.76亿元。",
    },
    {
        "year": 2023,
        "city_name": "襄阳市",
        "city_id": "CN-420600",
        "source_doc_id": "SRC-B2-XIANGYANG-CITY-FUND-2023",
        "url": "https://static.sse.com.cn/disclosure/bond/announcement/corporate/c/new/2025-06-27/152939_20250627_4TTS.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hubei_2023_city_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hubei_2023_city_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "襄阳市财政收支情况（评级报告精确表格）",
        "publisher": "襄阳市财政公开数据（经东方金诚评级报告精确引用）",
        "publisher_level": "市级财政数据/评级报告",
        "publication_date": "2025-06-27",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"襄阳市2023年全市政府性基金预算收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2023年全市政府性基金收入执行数",
        "document_type": "评级报告精确财政表格",
        "page_count": "",
        "note": "B2精确表格；表中2023年襄阳市全市政府性基金预算收入211.00亿元，来源注明襄阳市财政局数据；不使用市本级数。",
    },
    {
        "year": 2023,
        "city_name": "达州市",
        "city_id": "CN-511700",
        "source_doc_id": "SRC-A1-DAZHOU-CITY-FUND-2023",
        "url": "https://www.dazhou.gov.cn/uploadfile/1/Attachment/7c054bb35d.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "sichuan_2023_city_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "sichuan_2023_city_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于达州市2023年财政决算的报告",
        "publisher": "达州市人民政府",
        "publisher_level": "市级政府官网",
        "publication_date": "2024-09-30",
        "source_grade": "A1",
        "source_format": "pdf",
        "pattern": r"达州市2023年全市政府性基金收入决算数=([0-9]+)万元",
        "raw_unit": "万元",
        "data_status": "reported",
        "data_status_label": "2023年全市政府性基金收入决算数",
        "document_type": "官方全市财政决算报告",
        "page_count": "",
        "note": "A1达州市人民政府官方财政决算报告；全市政府性基金收入2151213万元，折算为215.12亿元；不使用市级579324万元。",
    },
    {
        "year": 2023,
        "city_name": "南充市",
        "city_id": "CN-511300",
        "source_doc_id": "SRC-B2-NANCHONG-CITY-FUND-2023",
        "url": "https://www.sse.com.cn/disclosure/bond/announcement/corporate/c/new/2024-06-21/152063_20240621_V9T8.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "sichuan_2023_city_fund_exact.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "sichuan_2023_city_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "南充市经济财政概况（评级报告精确表格）",
        "publisher": "中诚信国际（依据南充市公开财政资料）",
        "publisher_level": "评级机构/市级财政数据",
        "publication_date": "2024-06-21",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"南充市2023年全市政府性基金收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "reported",
        "data_status_label": "2023年全市政府性基金收入报告数",
        "document_type": "评级报告精确财政表格",
        "page_count": "",
        "note": "B2公开评级报告表1精确列示；南充市2023年政府性基金收入135.20亿元，采用全市口径，不使用图表估读。",
    },
    {
        "year": 2023,
        "city_name": "阿坝藏族羌族自治州",
        "city_id": "CN-513200",
        "source_doc_id": "SRC-A1-ABA-CITY-FUND-2023",
        "url": "https://abrd.gov.cn/zrdcwh/c104573/202411/4866acb758244c118813e5ad89ec51a1.shtml",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "sichuan_2023_city_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "sichuan_2023_city_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "阿坝州第十三届人民代表大会常务委员会公报第十九期",
        "publisher": "阿坝州人大常委会",
        "publisher_level": "州级人大官网",
        "publication_date": "2024-11-01",
        "source_grade": "A1",
        "source_format": "html",
        "pattern": r"阿坝藏族羌族自治州2023年全州政府性基金预算收入完成=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2023年全州政府性基金预算收入快报数",
        "document_type": "官方人大公报财政预算执行段落",
        "page_count": "1",
        "note": "A1阿坝州人大常委会官方公报；明确披露2023年全州政府性基金预算收入10.4亿元，属于快报执行数，保留execution状态。",
    },
    {
        "year": 2023,
        "city_name": "黄山市",
        "city_id": "CN-341000",
        "source_doc_id": "SRC-A1-HUANGSHAN-CITY-FUND-2023",
        "url": "https://www.huangshan.gov.cn/zxzx/zwyw/8397086.html",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "anhui_2023_huangshan_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "anhui_2023_huangshan_fund_excerpt.txt",
        "text_is_curated": True,
        ...
        "source_grade": "A1",
        "source_format": "html",
        "pattern": r"黄山市2023年全市政府性基金预算收入完成=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2023年全市政府性基金预算收入执行数",
        "document_type": "官方财政预算执行报告摘要",
        "page_count": "1",
        "note": "A1黄山市人民政府官方报告摘要及附件；全市政府性基金预算收入49.7亿元，明确区别于市级18.4亿元。",
    },
    {
        "year": 2023,
        "city_name": "永州市",
        "city_id": "CN-431100",
        "source_doc_id": "SRC-A1-YONGZHOU-CITY-FUND-2023",
        "url": "https://czj.yzcity.gov.cn/czj/030701/202506/faafa0d176ef417fb545aaad8710f700.shtml",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hunan_2023_yongzhou_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "hunan_2023_yongzhou_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "关于2023年市级决算草案和2024年上半年预算执行情况的报告",
        "publisher": "永州市财政局",
        "publisher_level": "市级财政部门官网",
        "publication_date": "2024-09-04",
        "source_grade": "A1",
        "source_format": "html",
        "pattern": r"永州市2023年全市政府性基金收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "reported",
        "data_status_label": "2023年全市政府性基金收入决算数",
        "document_type": "官方全市财政决算报告",
        "page_count": "1",
        "note": "A1永州市财政局官方决算报告；全市政府性基金收入235.29亿元，折算自官方决算表2352884万元；不使用市本级数。",
    },
    {
        "year": 2023,
        "city_name": "张家界市",
        "city_id": "CN-430800",
        "source_doc_id": "SRC-B2-ZHANGJIAJIE-CITY-FUND-2023",
        "url": "https://qxb-pdf-osscache.qixin.com/AnBaseinfo/035944ec77177a3c96b1b8ef50e4881a.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hunan_2023_zhangjiajie_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "hunan_2023_zhangjiajie_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "张家界市交通建设投资集团有限责任公司主体与相关债项2024年度跟踪评级报告",
        "publisher": "公开评级报告（依据张家界市财政公开资料）",
        "publisher_level": "评级机构/市级财政数据",
        "publication_date": "2024-06-28",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"张家界市2023年全市政府性基金收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "reported",
        "data_status_label": "2023年全市政府性基金收入报告数",
        "document_type": "评级报告精确财政表格",
        "page_count": "",
        "note": "B2报告表2精确列示2023年张家界市政府性基金收入14.98亿元；报告脚注仅将2021、2022年标为市本级，2023年按全市口径纳入。",
    },
)
...
# 广东省 2022—2023 年政府性基金收入精确值补缺。
# 清远、韶关采用财政部门官方预算/决算公开的全市口径；珠海、中山采用
# 公开评级报告中的精确财政表格。所有摘录均保存原始单位、行政范围和换算说明，
# 不使用图表估读、市本级或区县口径。
GUANGDONG_2022_2023_CITY_FUND_SOURCES = (
    {
        "year": 2022,
        "city_name": "清远市",
        "city_id": "CN-441800",
        "source_doc_id": "SRC-A2-GUANGDONG-QINGYUAN-FUND-2022",
        "url": "https://www.gdqy.gov.cn/attachment/0/109/109926/1678625.pdf",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "qingyuan_2022_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "qingyuan_2022_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "2023年清远市市级政府预算公开",
        "publisher": "清远市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2023",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"城市=清远市｜年度=2022｜政府性基金收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2022年全市政府性基金收入执行数",
        "document_type": "城市财政预算公开报告",
        "page_number": "正文‘政府性基金预算执行情况’",
        "page_count": "",
        "note": "A2官方预算公开；原文明确区分全市政府性基金收入65.05亿元与政府性基金总收入220.76亿元，采用全市收入口径。",
    },
    {
        "year": 2023,
        "city_name": "清远市",
        "city_id": "CN-441800",
        "source_doc_id": "SRC-A1-GUANGDONG-QINGYUAN-FUND-2023",
        "url": "https://www.gdqy.gov.cn/attachment/0/162/162534/1924495.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "qingyuan_2023_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "qingyuan_2023_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "2023年清远市本级政府决算公开",
        "publisher": "清远市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2024",
        "source_grade": "A1",
        "source_format": "pdf",
        "pattern": r"城市=清远市｜年度=2023｜政府性基金收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "final",
        "data_status_label": "2023年全市政府性基金收入决算数",
        "document_type": "城市财政决算公开报告",
        "page_number": "正文‘全市政府性基金收支决算情况’",
        "page_count": "",
        "note": "A1官方决算公开；原文为654847万元，标准化为65.4847亿元，采用全市口径。",
    },
    {
        "year": 2022,
        "city_name": "珠海市",
        "city_id": "CN-440400",
        "source_doc_id": "SRC-B2-GUANGDONG-ZHUHAI-FUND-2022",
        "url": "https://qxb-pdf-osscache.qixin.com/AnBaseinfo/0fc38b5889c013c4f9464f0a13244405.pdf",
        "path": RAW_DIR / "province_fiscal" / "2022" / "secondary" / "zhuhai_2022_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "secondary" / "zhuhai_2022_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "珠海市相关主体公开评级报告财政指标摘录",
        "publisher": "公开评级报告（资料来源注明珠海市财政局）",
        "publisher_level": "评级机构公开披露的精确表格二手来源",
        "publication_date": "2023",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"城市=珠海市｜年度=2022｜政府性基金收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "reported",
        "data_status_label": "2022年全市政府性基金收入公开精确值",
        "document_type": "评级报告财政指标表",
        "page_number": "财政实力与政府性基金收入段落",
        "page_count": "",
        "note": "B2精确表格/正文；报告明确列示2022年珠海市全市政府性基金预算收入369.94亿元，不使用图表估读。",
    },
    {
        "year": 2022,
        "city_name": "中山市",
        "city_id": "CN-442000",
        "source_doc_id": "SRC-B2-GUANGDONG-ZHONGSHAN-FUND-2022",
        "url": "https://qxb-pdf-osscache.qixin.com/AnBaseinfo/50f9d3a72a2b7ef7529965a8355ca495.pdf",
        "path": RAW_DIR / "province_fiscal" / "2022" / "secondary" / "zhongshan_2022_fund_exact_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "secondary" / "zhongshan_2022_fund_exact_excerpt.txt",
        "text_is_curated": True,
        "document_title": "2025年度中山城市建设集团有限公司信用评级报告",
        "publisher": "中诚信国际信用评估有限责任公司",
        "publisher_level": "评级机构公开披露的精确表格二手来源",
        "publication_date": "2026",
        "source_grade": "B2",
        "source_format": "pdf",
        "pattern": r"城市=中山市｜年度=2022｜政府性基金收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "reported",
        "data_status_label": "2022年全市政府性基金收入公开精确值",
        "document_type": "评级报告财政指标表",
        "page_number": "表3‘近年来中山市经济财政情况’",
        "page_count": "",
        "note": "B2精确表格；表3列示2022年中山市全市政府性基金收入121.60亿元，不使用市本级预算数或图表估读。",
    },
    {
        "year": 2023,
        "city_name": "韶关市",
        "city_id": "CN-440200",
        "source_doc_id": "SRC-A2-GUANGDONG-SHAOGUAN-FUND-2023",
        "url": "https://www.sg.gov.cn/attachment/0/232/232822/2584224.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "shaoguan_2023_fund_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "shaoguan_2023_fund_excerpt.txt",
        "text_is_curated": True,
        "document_title": "2024年韶关市市级政府预算公开",
        "publisher": "韶关市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2024",
        "source_grade": "A2",
        "source_format": "pdf",
        "pattern": r"城市=韶关市｜年度=2023｜政府性基金收入=([0-9.]+)亿元",
        "raw_unit": "亿元",
        "data_status": "execution",
        "data_status_label": "2023年全市政府性基金收入执行数",
        "document_type": "城市财政预算执行报告",
        "page_number": "正文‘全市政府性基金预算执行情况’",
        "page_count": "",
        "note": "A2官方预算公开；原文为314023万元，标准化为31.4023亿元，采用全市口径，不使用市本级113810万元。",
    },
)
...
# 保山、绥化2024年官方统计公报同时披露GDP、实际增速和全市一般公共
# 预算收支，作为四字段整批补缺来源；公报注明相关数据为初步统计数。
CITY_YEAR_FISCAL_SOURCES += (
    {
        "year": 2024,
        "city_name": "保山市",
        "city_id": "CN-530500",
        "source_doc_id": "SRC-A2-BAOSHAN-CITY-BULLETIN-2024-MACRO-FISCAL",
        "url": "https://www.baoshan.gov.cn/info/4213/10199004.htm",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "baoshan_2024_statistical_bulletin.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "baoshan_2024_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "2024年保山市国民经济和社会发展统计公报",
        "publisher": "保山市统计局",
        ...
        "document_type": "官方城市统计公报",
        "page_number": "网页正文‘一、综合’及财政部分",
        "raw_unit": "亿元",
        "raw_units": {"gdp_real_growth_pct": "%"},
        "patterns": {
            "gdp_current_100m": r"地区生产总值（GDP）\s*([0-9.]+)\s*亿元",
            "gdp_real_growth_pct": r"地区生产总值（GDP）\s*[0-9.]+\s*亿元，按可比价格计算，比上年增长\s*([0-9.]+)%",
            "general_public_revenue_100m": r"一般公共预算收入\s*([0-9.]+)\s*亿元",
            "general_public_expenditure_100m": r"一般公共预算支出\s*([0-9.]+)\s*亿元",
        },
        "source_locator": "baoshan_2024_statistical_bulletin_excerpt.txt；官方网页‘一、综合’及财政部分；城市=保山市；2024年全市初步统计数",
        "note": "A2保山市统计局官方统计公报；明确全市GDP、按可比价格计算的增速和一般公共预算收支；本批不使用财政总收入、财政总支出或分县数据。",
    },
    {
        "year": 2024,
        "city_name": "绥化市",
        "city_id": "CN-231200",
        "source_doc_id": "SRC-A2-SUIHUA-CITY-BULLETIN-2024-MACRO-FISCAL",
        "url": "https://www.suihua.gov.cn/sh/tjxx/202505/c12_210215.shtml",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "suihua_2024_statistical_bulletin.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "suihua_2024_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "绥化市2024年国民经济和社会发展统计公报",
        "publisher": "绥化市统计局",
        "publisher_level": "市级统计机构官方统计公报公开页",
        ...
        "data_status_label": "2024年公报初步统计数",
        "document_type": "官方城市统计公报",
        "page_number": "网页正文‘一、综合’及‘八、财政和金融’",
        "raw_unit": "亿元",
        "raw_units": {"gdp_real_growth_pct": "%"},
        "patterns": {
            "gdp_current_100m": r"地区生产总值\s*([0-9.]+)\s*亿元，比上年增长\s*[0-9.]+%",
            "gdp_real_growth_pct": r"地区生产总值\s*[0-9.]+\s*亿元，比上年增长\s*([0-9.]+)%",
            "general_public_revenue_100m": r"一般公共预算收入\s*([0-9.]+)\s*亿元",
            "general_public_expenditure_100m": r"一般公共预算支出\s*([0-9.]+)\s*亿元",
        },
        "source_locator": "suihua_2024_statistical_bulletin_excerpt.txt；官方网页‘一、综合’及‘八、财政和金融’；城市=绥化市；2024年全市初步统计数",
        "note": "A2绥化市统计局官方统计公报公开页；明确全市GDP、同比增速和一般公共预算收支；本批不使用分项支出或其他财政总量。",
    },
)
...
# 辽宁省政府统计公报索引所链接的两份 2025 年市级官方公报，直接披露全市
# GDP、实际增速和一般公共预算收支。公报注明为初步统计数，不使用市本级数。
CITY_YEAR_FISCAL_SOURCES += (
    {
        "year": 2025,
        "city_name": "葫芦岛市",
        "city_id": "CN-211400",
        "source_doc_id": "SRC-A2-HULUDAO-CITY-BULLETIN-2025-CORE",
        "url": "https://www.hld.gov.cn/zwgk/fdzdgknr/tjxx/gongbao/202605/t20260526_1237937.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "huludao_2025_statistical_bulletin.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "huludao_2025_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "2025年葫芦岛市国民经济和社会发展统计公报",
        "publisher": "葫芦岛市统计局",
        "publisher_level": "葫芦岛市政府官网官方统计公报",
        "publication_date": "2026-05-26",
        "source_grade": "A2",
        "source_format": "html",
        "data_status": "preliminary",
        "data_status_label": "2025年初步统计数",
        "document_type": "官方统计公报（网页）",
        "page_number": "网页正文第一部分及第八部分",
        "raw_unit": "亿元",
        "raw_units": {"gdp_real_growth_pct": "%"},
        "patterns": {
        ...
        "source_locator": "网页正文第一部分及第八部分；城市=葫芦岛市；2025年全市初步统计数",
        "note": "A2官方统计公报；GDP、增速及一般公共预算收支均为葫芦岛市全市口径，公报注释标明为初步统计数；不使用市本级数。",
    },
    {
        "year": 2025,
        "city_name": "辽阳市",
        "city_id": "CN-211000",
        "source_doc_id": "SRC-A2-LIAOYANG-CITY-BULLETIN-2025-CORE",
        "url": "https://tjj.liaoyang.gov.cn/tjgz/002005/20260601/541c2436-0b20-4079-b2c9-f5c201d28c89.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "liaoyang_2025_statistical_bulletin.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "liaoyang_2025_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "二〇二五年辽阳市国民经济和社会发展统计公报",
        "publisher": "辽阳市统计局",
        "publisher_level": "辽阳市统计局官网官方统计公报",
        "publication_date": "2026-06-01",
        "source_grade": "A2",
        "source_format": "html",
        "data_status": "preliminary",
        "data_status_label": "2025年初步统计数（年快报）",
        "document_type": "官方统计公报（网页）",
        "page_number": "网页正文第一部分及第八部分",
        "raw_unit": "亿元",
        "raw_units": {"gdp_real_growth_pct": "%"},
        ...
        "source_locator": "网页正文第一部分及第八部分；城市=辽阳市；2025年全市初步统计数（年快报）",
        "note": "A2官方统计公报；GDP、增速及地方一般公共预算收支均为辽阳市全市口径，正文说明根据年快报统计；不使用市本级数。",
    },
)

# 西宁官方统计公报 PDF 与甘南州官方统计公报转载页，分别直接披露 2025 年
# 全市/全州 GDP、实际增速和一般公共预算收支；均不使用市本级或州本级口径。
CITY_YEAR_FISCAL_SOURCES += (
    {
        "year": 2025,
        "city_name": "西宁市",
        "city_id": "CN-630100",
        "source_doc_id": "SRC-A2-XINING-CITY-BULLETIN-2025-CORE",
        "url": "https://tjj.xining.gov.cn/zwgk/fdzdgknr/tjxx/tjgb/202605/P020260630366794547088.pdf",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "xining_2025_statistical_bulletin.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "xining_2025_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "西宁市2025年国民经济和社会发展统计公报",
        "publisher": "西宁市统计局",
        "publisher_level": "西宁市统计局官网官方统计公报",
        "publication_date": "2026-05-06",
        "source_grade": "A2",
        "source_format": "pdf",
        "data_status": "preliminary",
        "data_status_label": "2025年初步统计数",
        "document_type": "官方统计公报（PDF）",
        "page_number": "PDF第1、13—14页",
        "raw_unit": "亿元",
        "raw_units": {"gdp_real_growth_pct": "%"},
        "patterns": {
            "gdp_current_100m": r"地区生产总值为([0-9.]+)亿元",
            "gdp_real_growth_pct": r"地区生产总值为[0-9.]+亿元，按不变价格计算，比上年增长([0-9.]+)%",
            "general_public_revenue_100m": r"全年一般公共预算收入([0-9.]+)亿元",
            "general_public_expenditure_100m": r"全年一般公共预算支出([0-9.]+)亿元",
        },
        "source_locator": "raw/province_fiscal/2025/official/xining_2025_statistical_bulletin_excerpt.txt；PDF第1、13—14页；城市=西宁市；2025年全市初步统计数",
        "note": "A2官方统计公报；GDP来自地区生产总值统一核算结果，一般公共预算收入和支出为全市口径；财政数据来源注明为西宁市财政局；不使用地方一般公共预算收入103.7亿元替代全口径一般公共预算收入213.4亿元。",
    },
    {
        "year": 2025,
        "city_name": "甘南藏族自治州",
        "city_id": "CN-623000",
        "source_doc_id": "SRC-A2-GANNAN-STATE-BULLETIN-2025-CORE",
        "url": "https://www.tewo.gov.cn/info/1842/61667.htm",
        "path": RAW_DIR / "province_fiscal" / "2025" / "official" / "gannan_2025_statistical_bulletin.html",
        "text_path": RAW_DIR / "province_fiscal" / "2025" / "official" / "gannan_2025_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "2025年甘南藏族自治州国民经济和社会发展统计公报",
        "publisher": "甘南藏族自治州统计局、国家统计局甘南调查队",
        "publisher_level": "州级统计机构官方公报（县级政府官网转载）",
        "publication_date": "2026-06-24",
        "source_grade": "A2",
        "source_format": "html",
        "data_status": "preliminary",
        "data_status_label": "2025年初步统计数",
        "document_type": "官方统计公报（政府网站转载）",
        "page_number": "网页正文‘一、综合’及‘七、财政金融’",
        "raw_unit": "亿元",
        "raw_units": {"gdp_real_growth_pct": "%"},
        "patterns": {
            "gdp_current_100m": r"全年全州实现地区生产总值([0-9.]+)亿元",
            "gdp_real_growth_pct": r"全年全州实现地区生产总值[0-9.]+亿元，按不变价格计算，比上年增长([0-9.]+)%",
            "general_public_revenue_100m": r"全年全州一般公共预算收入([0-9.]+)亿元",
            "general_public_expenditure_100m": r"一般公共财政预算支出([0-9.]+)亿元",
        },
        "source_locator": "raw/province_fiscal/2025/official/gannan_2025_statistical_bulletin_excerpt.txt；网页正文‘一、综合’及‘七、财政金融’；州=甘南藏族自治州；2025年全州初步统计数",
        "note": "A2官方统计公报转载；公报署名甘南州统计局、国家统计局甘南调查队，数据为全州口径；财政支出原文称‘一般公共财政预算支出’，按原文对应一般公共预算支出字段，不使用州本级数。",
    },
)
CITY_YEAR_FISCAL_SOURCES += tuple(
    {
...
CITY_YEAR_FISCAL_SOURCES += tuple(XUEYAN_PUBLIC_PREVIEW_FUND_SOURCES)
...
_CURATED_2024_2025_MACRO_PRIORITY_SPECS = (
    ...
    },
    {
        ...
        "city_name": "松原市",
        "city_id": "CN-220700",
        "source_doc_id": "SRC-B2-SONGYUAN-STATISTICAL-BULLETIN-2025-EXPENDITURE",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/74411.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "songyuan_2025_statistical_bulletin_excerpt.txt",
        "document_title": "（吉林省）松原市2025年国民经济和社会发展统计公报",
        "publisher": "松原市统计局公报公开转载",
        "publisher_level": "市级统计机构公报转载",
        ...
        "document_type": "市级统计公报财政指标精确转载",
        "page_number": "转载正文八、财政金融",
        "note": "B2精确公报转载；原始公报正文明确披露松原市全市2025年“地方财政支出”308.03亿元。本批依据同段财政指标语境及地方统计口径映射为一般公共预算支出，仅接入全市年度执行结果，不接入预算安排、本级支出或全口径财政收入。",
    },
    {
        "year": 2025,
        "city_name": "白城市",
...
CITY_YEAR_FISCAL_SOURCES += (
    ...
    },
    {
        ...
        "patterns": {
            "general_public_revenue_100m": r"全市一般公共预算收入\s*([0-9,]+)\s*万元",
            "general_public_expenditure_100m": r"全市一般公共预算支出\s*([0-9,]+)\s*万元",
            "gov_fund_revenue_100m": r"政府性基金预算收入完成\s*([0-9,]+)\s*万元，为预算的62\.3%",
        },
        "source_locator": "wuzhong_2024_budget_report_excerpt.txt；官方报告全市一般公共预算全口径收支说明；城市=吴忠市；2024年全市决算数",
        "note": "A2吴忠市财政局官方决算公开页；报告同时列示全市与市本级数，本批仅使用全市一般公共预算收入431,363万元、支出2,793,743万元，以及全市政府性基金预算收入43,042万元，按万元换算为亿元，不使用市本级数。",
    },
)
...
CITY_YEAR_FISCAL_SOURCES += (
    {
        ...
        "city_name": "巴音郭楞蒙古自治州",
        "city_id": "CN-652800",
        "source_doc_id": "SRC-A2-BAZHOU-CITY-BULLETIN-2022-MACRO-FISCAL",
        "url": "https://www.xjbz.gov.cn/xjbz/c101602/202304/d1eacbc5bbf7406a93c04882b9941e09.shtml",
        "download_url": "https://www.xjbz.gov.cn/xjbz/c101602/202304/d1eacbc5bbf7406a93c04882b9941e09/files/%E5%B7%B4%E9%9F%B3%E9%83%AD%E6%A5%9E%E8%92%99%E5%8F%A4%E8%87%AA%E6%B2%BB%E5%B7%9E2022%E5%B9%B4%E5%9B%BD%E6%B0%91%E7%BB%8F%E6%B5%8E%E5%92%8C%E7%A4%BE%E4%BC%9A%E5%8F%91%E5%B1%95%E7%BB%9F%E8%AE%A1%E5%85%AC%E6%8A%A5.pdf",
        "attachment_url": "https://www.xjbz.gov.cn/xjbz/c101602/202304/d1eacbc5bbf7406a93c04882b9941e09/files/%E5%B7%B4%E9%9F%B3%E9%83%AD%E6%A5%9E%E8%92%99%E5%8F%A4%E8%87%AA%E6%B2%BB%E5%B7%9E2022%E5%B9%B4%E5%9B%BD%E6%B0%91%E7%BB%8F%E6%B5%8E%E5%92%8C%E7%A4%BE%E4%BC%9A%E5%8F%91%E5%B1%95%E7%BB%9F%E8%AE%A1%E5%85%AC%E6%8A%A5.pdf",
        "path": RAW_DIR / "province_fiscal" / "2022" / "official" / "bazhou_2022_statistical_bulletin.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2022" / "official" / "bazhou_2022_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "巴音郭楞蒙古自治州2022年国民经济和社会发展统计公报",
        "publisher": "巴州统计局",
        "publisher_level": "自治州统计机构官方统计公报",
        "publication_date": "2023-04-14",
        "source_grade": "A2",
        "source_format": "pdf",
        "data_status": "preliminary",
        "data_status_label": "2022年公报初步统计数",
        "document_type": "官方自治州统计公报",
        "page_number": "官方PDF第1页、第9页",
        "raw_unit": "亿元",
        "raw_units": {"gdp_real_growth_pct": "%"},
        "patterns": {
            "gdp_current_100m": r"全州实现生产总值（GDP）\s*([0-9.]+)\s*亿元",
    ...
    },
    {
        ...
        "city_name": "巴音郭楞蒙古自治州",
        "city_id": "CN-652800",
        "source_doc_id": "SRC-A2-BAZHOU-CITY-BULLETIN-2023-MACRO-FISCAL",
        "url": "https://www.xjbz.gov.cn/xjbz/c101602/202408/0a96c7e56aac4fd28e2b4b03fd386ac4.shtml",
        "download_url": "https://www.xjbz.gov.cn/xjbz/c101602/202408/0a96c7e56aac4fd28e2b4b03fd386ac4/files/%E5%B7%B4%E9%9F%B3%E9%83%AD%E6%A5%9E%E8%92%99%E5%8F%A4%E8%87%AA%E6%B2%BB%E5%B7%9E2023%E5%B9%B4%E5%9B%BD%E6%B0%91%E7%BB%8F%E6%B5%8E%E5%92%8C%E7%A4%BE%E4%BC%9A%E5%8F%91%E5%B1%95%E7%BB%9F%E8%AE%A1%E5%85%AC%E6%8A%A5.pdf",
        "attachment_url": "https://www.xjbz.gov.cn/xjbz/c101602/202408/0a96c7e56aac4fd28e2b4b03fd386ac4/files/%E5%B7%B4%E9%9F%B3%E9%83%AD%E6%A5%9E%E8%92%99%E5%8F%A4%E8%87%AA%E6%B2%BB%E5%B7%9E2023%E5%B9%B4%E5%9B%BD%E6%B0%91%E7%BB%8F%E6%B5%8E%E5%92%8C%E7%A4%BE%E4%BC%9A%E5%8F%91%E5%B1%95%E7%BB%9F%E8%AE%A1%E5%85%AC%E6%8A%A5.pdf",
        "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "bazhou_2023_statistical_bulletin.pdf",
        "text_path": RAW_DIR / "province_fiscal" / "2023" / "official" / "bazhou_2023_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "巴音郭楞蒙古自治州2023年国民经济和社会发展统计公报",
        "publisher": "巴音郭楞蒙古自治州统计局、国家统计局巴音郭楞调查队",
        "publisher_level": "自治州统计机构官方统计公报",
        ...
        "source_format": "pdf",
        "data_status": "preliminary",
        "data_status_label": "2023年公报初步统计数",
        "document_type": "官方自治州统计公报",
        "page_number": "官方PDF第1页、第10页",
        "raw_unit": "亿元",
        "raw_units": {"gdp_real_growth_pct": "%"},
        "patterns": {
            "gdp_current_100m": r"全州实现生产总值（GDP）\s*([0-9.]+)\s*亿元",
        ...
        "source_locator": "bazhou_2023_statistical_bulletin_excerpt.txt；官方PDF第1页、第10页；城市=巴音郭楞蒙古自治州；2023年全州初步统计数",
        "note": "A2巴音郭楞蒙古自治州统计局官方统计公报；明确全州GDP、同比增速和地方一般公共预算收支；本批不以铁门关市或分项数据替代全州口径。",
    },
    {
        "year": 2024,
        "city_name": "海东市",
        "city_id": "CN-630200",
        "source_doc_id": "SRC-B2-HAIDONG-CITY-BULLETIN-2024-FISCAL",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/57425.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "haidong_2024_statistical_bulletin.html",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "haidong_2024_statistical_bulletin_excerpt.txt",
        "text_is_curated": True,
        "document_title": "海东市2024年国民经济和社会发展统计公报",
        "publisher": "海东市统计局、国家统计局海东调查队（公报公开转载）",
        "publisher_level": "市级统计机构公报精确公开转载",
        "publication_date": "2025-03-22",
        "source_grade": "B2",
        "source_format": "html",
        "data_status": "preliminary",
        "data_status_label": "2024年公报公开值",
        "document_type": "市级统计公报财政指标精确转载",
        "page_number": "转载正文‘七、财政和金融’",
        "raw_unit": "亿元",
        "raw_units": {},
        "patterns": {
            "general_public_revenue_100m": r"2024年全市一般公共预算收入\s*([0-9.]+)\s*亿元",
            "general_public_expenditure_100m": r"全市一般公共预算支出\s*([0-9.]+)\s*亿元",
        },
        "source_locator": "haidong_2024_statistical_bulletin_excerpt.txt；官方公报精确公开转载正文‘七、财政和金融’；城市=海东市；2024年全市公报公开值",
        "note": "B2精确公报转载；原始公报PDF入口已检索但当前动态链接无法直接取得，故不标记为A2；转载正文明确全市一般公共预算收入31.36亿元、支出292.63亿元，未使用部门预算或区县数据。",
    },
)

# 本批补入2022—2025年公开精确统计公报中的四字段缺口。来源页面均标明
# 市（州）统计机构和全市（州）口径；摘录只保留主表当前缺失的字段，避免
# 低等级来源覆盖已有值。
_CURATED_2022_2025_MACRO_GAP_BATCH_2_SPECS = (
    {
        "year": 2024,
        "city_name": "衡水市",
        "city_id": "CN-131100",
        "source_doc_id": "SRC-B2-HENGSHUI-CITY-FISCAL-2024",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/62528.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "hengshui_2024_statistical_bulletin_excerpt.txt",
        "document_title": "衡水市2024年国民经济和社会发展统计公报",
        "publisher": "衡水市统计局、国家统计局衡水调查队（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        ...
        "data_status_label": "2024年公报初步统计数",
        "document_type": "市级统计公报财政指标精确转载",
        "page_number": "转载正文‘八、财政金融’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；来源页面标明衡水市统计局和国家统计局衡水调查队，采用衡水市全市一般公共预算收入152.7亿元、支出451.7亿元。",
    },
    {
        "year": 2024,
        "city_name": "朔州市",
        "city_id": "CN-140600",
        "source_doc_id": "SRC-B2-SHUOZHOU-CITY-FISCAL-2024",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/60806.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "shuozhou_2024_statistical_bulletin_excerpt.txt",
        "document_title": "朔州市2024年国民经济和社会发展统计公报",
        "publisher": "朔州市统计局（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        "publication_date": "2025-04-28",
        "source_grade": "B2",
        "fields": ("general_public_expenditure_100m",),
        ...
        "data_status_label": "2024年公报初步统计数",
        "document_type": "市级统计公报财政指标精确转载",
        "page_number": "转载正文‘八、财政金融保险’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；采用朔州市全市一般公共预算支出261.46亿元，不使用县区或市本级数据。",
    },
    {
        "year": 2024,
        "city_name": "阜阳市",
        "city_id": "CN-341200",
        "source_doc_id": "SRC-B2-FUYANG-CITY-FISCAL-2024",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/64849.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "fuyang_2024_statistical_bulletin_excerpt.txt",
        "document_title": "阜阳市2024年国民经济和社会发展统计公报",
        "publisher": "阜阳市统计局（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        "publication_date": "2025-06-27",
        "source_grade": "B2",
        "fields": ("general_public_revenue_100m", "general_public_expenditure_100m"),
        ...
        "data_status_label": "2024年公报初步统计数",
        "document_type": "市级统计公报财政指标精确转载",
        "page_number": "转载正文‘七、财政、金融和保险’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；采用阜阳市全市一般公共预算收入195.1亿元、支出662.3亿元，不使用县区数据。",
    },
    {
        "year": 2024,
        "city_name": "随州市",
        "city_id": "CN-421300",
        "source_doc_id": "SRC-B2-SUIZHOU-CITY-FISCAL-2024",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/58152.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "suizhou_2024_statistical_bulletin_excerpt.txt",
        "document_title": "随州市2024年国民经济和社会发展统计公报",
        "publisher": "随州市统计局、国家统计局随州调查队（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        "publication_date": "2025-03-31",
        "source_grade": "B2",
        "fields": ("general_public_expenditure_100m",),
        ...
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；来源页面标明随州市统计局和国家统计局随州调查队，采用随州市全市地方一般公共预算支出238.37亿元。",
    },
    {
        "year": 2024,
        "city_name": "山南市",
        "city_id": "CN-540500",
        "source_doc_id": "SRC-B2-SHANNAN-CITY-FISCAL-2024",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/65709.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "shannan_2024_statistical_bulletin_excerpt.txt",
        "document_title": "山南市2024年国民经济和社会发展统计公报",
        "publisher": "山南市统计局（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        ...
        "data_status_label": "2024年公报初步统计数",
        "document_type": "市级统计公报财政指标精确转载",
        "page_number": "转载正文‘七、财政金融’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；采用山南市全市一般公共预算收入21.4亿元、支出284.5亿元，不使用市本级或区县数字。",
    },
    {
        "year": 2024,
        "city_name": "那曲市",
        "city_id": "CN-540600",
        "source_doc_id": "SRC-B2-NAQU-CITY-FISCAL-2024",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/64055.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "naqu_2024_statistical_bulletin_excerpt.txt",
        "document_title": "那曲市2024年国民经济和社会发展统计公报",
        "publisher": "那曲市统计局（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        ...
        "source_format": "html",
        "data_status": "preliminary",
        "data_status_label": "2024年公报统计数",
        "document_type": "市级统计公报财政指标精确转载",
        "page_number": "转载正文‘七、财政和金融’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；原文单位为万元，采用那曲市全市一般公共预算收入114263万元、支出3194806万元，已按10000万元=1亿元换算。",
    },
    {
        "year": 2025,
        "city_name": "萍乡市",
        "city_id": "CN-360300",
        "source_doc_id": "SRC-B2-PINGXIANG-CITY-FISCAL-2025",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/76987.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "pingxiang_2025_statistical_bulletin_excerpt.txt",
        "document_title": "萍乡市2025年国民经济和社会发展统计公报",
        "publisher": "萍乡市统计局（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        ...
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；正文注明财政数据来自萍乡市财政局，采用萍乡市全市一般公共预算支出334.77亿元。",
    },
    {
        "year": 2025,
        "city_name": "德阳市",
        "city_id": "CN-510600",
        "source_doc_id": "SRC-B2-DEYANG-CITY-MACRO-FISCAL-2025",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/77129.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "deyang_2025_statistical_bulletin_excerpt.txt",
        "document_title": "2025年德阳市国民经济和社会发展统计公报",
        "publisher": "德阳市统计局（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        "publication_date": "2026-08-11",
        "source_grade": "B2",
        "fields": ("gdp_real_growth_pct", "general_public_expenditure_100m"),
        "raw_units": {"gdp_real_growth_pct": "%"},
        "source_format": "html",
        "data_status": "preliminary",
        "data_status_label": "2025年公报初步统计数",
        "document_type": "市级统计公报经济财政指标精确转载",
        "page_number": "转载正文‘一、综合’及‘九、财政和金融’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；采用德阳市全市GDP按不变价格计算的实际增速5.4%和一般公共预算支出437.3亿元。",
    },
    {
        "year": 2025,
        "city_name": "广元市",
        "city_id": "CN-510800",
        "source_doc_id": "SRC-B2-GUANGYUAN-CITY-MACRO-FISCAL-2025",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/68971.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "guangyuan_2025_statistical_bulletin_excerpt.txt",
        "document_title": "2025年广元市国民经济和社会发展统计公报",
        "publisher": "广元市统计局、国家统计局广元调查队（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        ...
        "data_status_label": "2025年公报初步统计数",
        "document_type": "市级统计公报经济财政指标精确转载",
        "page_number": "转载正文‘一、综合’及‘七、财政、金融与保险’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；来源页面标明广元市统计局和国家统计局广元调查队，采用广元市全市GDP实际增速6.4%和一般公共预算支出353.36亿元。",
    },
    {
        "year": 2025,
        "city_name": "襄阳市",
        "city_id": "CN-420600",
        "source_doc_id": "SRC-B2-XIANGYANG-CITY-GROWTH-2025",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/74464.html",
        "path": RAW_DIR / "province_fiscal" / "2025" / "secondary" / "xiangyang_2025_statistical_bulletin_excerpt.txt",
        "document_title": "襄阳市2025年国民经济和社会发展统计公报",
        "publisher": "襄阳市统计局（公开转载）",
        "publisher_level": "市级统计机构公报精确转载",
        "publication_date": "2026-06-22",
        "source_grade": "B2",
        "fields": ("gdp_real_growth_pct",),
        ...
        "source_format": "html",
        "data_status": "preliminary",
        "data_status_label": "2025年公报快报数",
        "document_type": "市级统计公报经济指标精确转载",
        "page_number": "转载正文‘一、综合’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；采用襄阳市全市GDP按不变价格计算的实际增速2.1%，公报注明财政数据来自市财政局，本批不覆盖财政字段。",
    },
    {
        "year": 2022,
        "city_name": "黄南藏族自治州",
        "city_id": "CN-632300",
        "source_doc_id": "SRC-B2-HUANGNAN-PREFECTURE-MACRO-2022",
        "url": "https://tjgb.hongheiku.com/xjtjgb/xj2020/38746.html",
        "path": RAW_DIR / "province_fiscal" / "2022" / "secondary" / "huangnan_2022_statistical_bulletin_excerpt.txt",
        "document_title": "2022年黄南州国民经济和社会发展统计公报",
        "publisher": "黄南藏族自治州统计局（公开转载）",
        "publisher_level": "自治州统计机构公报精确转载",
        ...
        "source_format": "html",
        "data_status": "preliminary",
        "data_status_label": "2022年公报统计数",
        "document_type": "自治州统计公报经济指标精确转载",
        "page_number": "转载正文‘一、综合’",
        "title_source": "official_statistical_bulletin",
        "access_status": "public_repost",
        "note": "B2精确公报转载；采用黄南藏族自治州全州地区生产总值110.89亿元及按可比价格计算的实际增速0.2%，本批只覆盖主表缺失的GDP和增速。",
    },
)
...
_CURATED_2023_2025_MACRO_GAP_BATCH_SPECS = (
    ...
    },
    {
        ...
        "city_name": "黄石市",
        "city_id": "CN-420200",
        "source_doc_id": "SRC-A1-HUANGSHI-CITY-FUND-2024-FINAL",
        "url": "https://czj.huangshi.gov.cn/2020xxgkzn/2020gknr/2020czzj/sbjyjs/202509/t20250923_1262650.html",
        "attachment_url": "https://czj.huangshi.gov.cn/2020xxgkzn/2020gknr/2020czzj/sbjyjs/202509/t20250923_1262650.html",
        "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "huangshi_2024_decision_excerpt.txt",
        "text_path": RAW_DIR / "province_fiscal" / "2024" / "official" / "huangshi_2024_decision_excerpt.txt",
        "document_title": "黄石市2024年政府决算公开表：表十全市政府性基金收入决算表",
        "publisher": "黄石市财政局",
        "publisher_level": "市级财政机构",
        "publication_date": "2025-09-12",
        "source_grade": "A1",
        ...
        "data_status": "final",
        "data_status_label": "2024年决算数",
        "document_type": "市级财政政府决算公开表",
        "page_number": "表十",
        "custom_patterns": {
            "gov_fund_revenue_100m": r"黄石市政府性基金预算收入\s*([0-9,]+)",
        },
        "note": "官方决算表表十列示黄石市全市政府性基金预算收入1279283万元，按0.0001换算为127.9283亿元；不使用市直基金收入。",
    },
    {
        "year": 2024,
        "city_name": "鄂州市",
...
CITY_YEAR_FISCAL_SOURCES += (HAINAN_DIRECT_ADMIN_2025_MONTHLY_SOURCE,)
...
# 2023—2024 年湖北、河南城市政府性基金收入补缺。湖北荆州、咸宁、荆门
# 使用中证鹏元公开评级报告中完整下辖单位表的精确汇总值；河南城市使用官方
# 财政报告或交易所公开评级报告的全市精确值。所有摘录均明确区分全市与市本级，
# 不把市本级、预算安排数或基金收入总量误作全市当年基金预算收入。
CITY_YEAR_FISCAL_SOURCES += tuple(
    _make_curated_city_source(**spec)
    for spec in (
        {
            ...
            "city_name": "荆州市",
            "city_id": "CN-421000",
            "source_doc_id": "SRC-B2-HUBEI-JINGZHOU-CITY-FUND-2024",
            "url": "https://www.cspengyuan.com/api/files/695fd73dbe22fa0776b8c005",
            "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "jingzhou_2024_fund_rating_excerpt.txt",
            "document_title": "荆州市城市投资开发有限公司相关债券2025年跟踪评级报告",
            "publisher": "中证鹏元资信评估股份有限公司",
            "publisher_level": "评级机构公开精确表格",
            ...
            "source_format": "txt",
            "data_status": "reported",
            "data_status_label": "2024年公开报告值（下辖单位完整汇总）",
            "document_type": "评级报告下辖区县政府性基金收入完整汇总",
            "page_number": "报告表2；PDF第7页；8个下辖单位全覆盖",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=荆州市｜年度=2024｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "jingzhou_2024_fund_rating_excerpt.txt；报告表2；PDF第7页；城市=荆州市；2024年公开报告值（下辖单位完整汇总）",
            "note": "B2中证鹏元公开精确表格；表2逐项列示沙市、松滋、荆州区、公安县、监利、洪湖、石首、江陵8个下辖单位，数值合计63.11亿元，作为荆州市全市口径汇总值；不使用市本级数或预算安排数。",
        },
        {
            "year": 2024,
            "city_name": "咸宁市",
            "city_id": "CN-421200",
            "source_doc_id": "SRC-B2-HUBEI-XIANNING-CITY-FUND-2024",
            "url": "https://www.chinamoney.com.cn/dqs/cm-s-notice-query/fileDownLoad.do?contentId=3137841&mode=save&priority=0",
            "path": RAW_DIR / "province_fiscal" / "2024" / "secondary" / "xianning_2024_fund_rating_excerpt.txt",
            "document_title": "咸宁高新投资集团有限公司相关债券跟踪评级报告",
            "publisher": "中证鹏元资信评估股份有限公司（中国货币网公开披露）",
            "publisher_level": "评级机构公开精确表格",
            "publication_date": "2025-06-13",
            "source_grade": "B2",
            "fields": ("gov_fund_revenue_100m",),
            ...
            "data_status_label": "2024年公开报告值（下辖单位完整汇总）",
            "document_type": "评级报告下辖区县政府性基金收入完整汇总",
            "page_number": "报告表2；PDF第7页；6个下辖单位全覆盖",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=咸宁市｜年度=2024｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "xianning_2024_fund_rating_excerpt.txt；报告表2；PDF第7页；城市=咸宁市；2024年公开报告值（下辖单位完整汇总）",
            "note": "B2中证鹏元公开精确表格；表2逐项列示赤壁、咸安、嘉鱼、通城、崇阳、通山6个下辖单位，数值合计55.24亿元，作为咸宁市全市口径汇总值；不使用市本级数或预算安排数。",
        },
        {
            "year": 2023,
            "city_name": "荆门市",
            "city_id": "CN-420800",
            "source_doc_id": "SRC-B2-HUBEI-JINGMEN-CITY-FUND-2023",
            "url": "https://www.cspengyuan.com/api/files/695fd71ebe22fa0776b8bfd6",
            "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "jingmen_2023_fund_rating_excerpt.txt",
            "document_title": "荆门市城市建设投资控股集团有限公司相关债券跟踪评级报告",
            "publisher": "中证鹏元资信评估股份有限公司",
            "publisher_level": "评级机构公开精确表格",
            ...
            "source_format": "txt",
            "data_status": "reported",
            "data_status_label": "2023年公开报告值（下辖单位完整汇总）",
            "document_type": "评级报告下辖区县政府性基金收入完整汇总",
            "page_number": "报告表2；5个下辖单位全覆盖",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=荆门市｜年度=2023｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "jingmen_2023_fund_rating_excerpt.txt；报告表2；城市=荆门市；2023年公开报告值（下辖单位完整汇总）",
            "note": "B2中证鹏元公开精确表格；表2逐项列示钟祥、掇刀、东宝、京山、沙洋5个下辖单位，数值合计47.57亿元，作为荆门市全市口径汇总值；不使用市本级数或预算安排数。",
        },
        {
            "year": 2023,
            "city_name": "平顶山市",
            "city_id": "CN-410400",
            "source_doc_id": "SRC-A2-HENAN-PINGDINGSHAN-CITY-FUND-2023",
            "url": "https://pds.gov.cn/contents/1378/400809.html",
            "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "pingdingshan_2023_budget_report_excerpt.txt",
            ...
            "data_status": "reported",
            "data_status_label": "2023年预算执行数",
            "document_type": "城市财政预算执行报告（官方网页摘录）",
            "page_number": "官方网页正文；2023年预算执行情况；全市口径",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=平顶山市｜年度=2023｜政府性基金预算收入=([0-9.,-]+)万元",
            },
            "source_locator": "pingdingshan_2023_budget_report_excerpt.txt；官方网页正文；城市=平顶山市；2023年预算执行数；行政范围=全市",
            "note": "A2平顶山市财政局官方报告；正文明确列示2023年全市政府性基金预算收入实际完成559121万元，采用全市执行口径，不使用市本级221000万元。",
        },
        {
            "year": 2023,
            "city_name": "新乡市",
            "city_id": "CN-410700",
            "source_doc_id": "SRC-B2-HENAN-XINXIANG-CITY-FUND-2023",
            "url": "https://news.xxrb.com.cn/special/2024/0222/21267.html",
            "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "xinxiang_2023_budget_report_excerpt.txt",
            "document_title": "新乡市2023年预算执行情况和2024年预算草案公开摘要",
            "publisher": "新乡市财政局（新乡日报公开转载）",
            "publisher_level": "市级财政机构公开转载",
            ...
            "data_status": "reported",
            "data_status_label": "2023年预算执行数",
            "document_type": "城市财政预算执行报告精确转载",
            "page_number": "公开摘要；2023年预算执行情况；全市口径",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=新乡市｜年度=2023｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "xinxiang_2023_budget_report_excerpt.txt；新乡日报公开摘要；城市=新乡市；2023年预算执行数；行政范围=全市",
            "note": "B2新乡市财政局预算执行信息的公开精确转载；摘要明确列示2023年全市政府性基金预算收入实际完成104.3亿元，采用全市口径，不使用市级预算安排数。",
        },
        {
            "year": 2023,
            "city_name": "信阳市",
            "city_id": "CN-411500",
            "source_doc_id": "SRC-B2-HENAN-XINYANG-CITY-FUND-2023",
            "url": "https://oss.dahe.cn/bdtypt/sbgt-wztipt/typtfile/20241220/8ddf90e1eb7e4f46b66ef8a9987a8691.pdf",
            "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "xinyang_2023_budget_report_excerpt.txt",
            "document_title": "信阳市2023年预算执行情况和2024年预算草案的报告",
            "publisher": "信阳市财政局（大河网公开附件）",
            "publisher_level": "市级财政机构公开附件",
            ...
            "data_status": "reported",
            "data_status_label": "2023年预算执行数",
            "document_type": "城市财政预算执行报告公开附件摘录",
            "page_number": "PDF第15页；全市政府性基金收支决算情况",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=信阳市｜年度=2023｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "xinyang_2023_budget_report_excerpt.txt；PDF第15页；城市=信阳市；2023年预算执行数；行政范围=全市",
            "note": "B2信阳市财政局公开附件；PDF第15页明确列示2023年汇总全市政府性基金预算收入实际完成104.39亿元，采用全市口径，不使用市级49.15亿元。",
        },
        {
            "year": 2023,
            "city_name": "开封市",
            "city_id": "CN-410200",
            "source_doc_id": "SRC-B2-HENAN-KAIFENG-CITY-FUND-2023",
            "url": "https://static.sse.com.cn/bond/bridge2/disclosure/announcement/c/202407/035534_20240708_JBFB.pdf",
            "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "kaifeng_2023_fund_rating_excerpt.txt",
            "document_title": "开封市城市发展集团有限公司主体及相关债券2024年跟踪评级报告",
            "publisher": "联合资信评估股份有限公司（上海证券交易所公开披露）",
            "publisher_level": "评级机构交易所公开精确表格",
            ...
            "data_status": "reported",
            "data_status_label": "2023年公开报告值",
            "document_type": "评级报告地级市政府性基金收入精确表格",
            "page_number": "PDF第9页表格；2021—2023年城市指标",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=开封市｜年度=2023｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "kaifeng_2023_fund_rating_excerpt.txt；PDF第9页表格；城市=开封市；2023年公开报告值；行政范围=全市",
            "note": "B2联合资信交易所公开报告第9页精确表格；表格列示开封市2023年政府性基金收入106.0亿元，资料来源注明为开封市财政决算和预算执行报告；不使用无法定位的图表估读。",
        },
        {
            "year": 2023,
            "city_name": "濮阳市",
            "city_id": "CN-410900",
            "source_doc_id": "SRC-B2-HENAN-PUYANG-CITY-FUND-2023",
            "url": "https://www.lhratings.com/reports/Q005505-P71963-2023-GZ2024.pdf",
            "path": RAW_DIR / "province_fiscal" / "2023" / "secondary" / "puyang_2023_fund_rating_excerpt.txt",
            "document_title": "濮阳市投资集团有限公司主体及相关债券2023年跟踪评级报告",
            "publisher": "联合资信评估股份有限公司",
            "publisher_level": "评级机构公开精确表格",
            "publication_date": "2024-06-28",
            "source_grade": "B2",
            ...
            "data_status": "reported",
            "data_status_label": "2023年公开报告值",
            "document_type": "评级报告地级市主要财力指标表",
            "page_number": "PDF第7页图表2；全市口径",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=濮阳市｜年度=2023｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "puyang_2023_fund_rating_excerpt.txt；PDF第7页图表2；城市=濮阳市；2023年公开报告值；行政范围=全市",
            "note": "B2联合资信公开精确表格；图表2明确列示濮阳市2023年政府性基金收入52.9亿元，和一般预算收入、支出同列为全市主要财力指标；不使用市本级口径。",
        },
        {
            "year": 2023,
            "city_name": "洛阳市",
            "city_id": "CN-410300",
            "source_doc_id": "SRC-A2-HENAN-LUOYANG-CITY-FUND-2023",
            "url": "https://oss.ly.gov.cn/upload-file/files/20241008/01beab80711e45488c59b4c24c05ec90.pdf",
            "path": RAW_DIR / "province_fiscal" / "2023" / "official" / "luoyang_2023_budget_report_excerpt.txt",
            "document_title": "关于2023年全市及市级财政决算的说明",
            "publisher": "洛阳市财政局",
            "publisher_level": "市级财政机构",
            ...
            "data_status": "final",
            "data_status_label": "2023年决算数",
            "document_type": "城市财政决算说明（官方PDF摘录）",
            "page_number": "PDF第8页；全市政府性基金收支决算情况",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=洛阳市｜年度=2023｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "luoyang_2023_budget_report_excerpt.txt；PDF第8页；城市=洛阳市；2023年决算数；行政范围=全市",
            "note": "A2洛阳市财政局官方决算说明；第8页明确列示汇总全市2023年政府性基金实际完成196.1亿元，采用全市决算口径，不使用市级122.2亿元。",
        },
        {
            "year": 2024,
            "city_name": "焦作市",
            "city_id": "CN-410800",
            "source_doc_id": "SRC-A2-HENAN-JIAOZUO-CITY-FUND-2024",
            "url": "https://czj.jiaozuo.gov.cn/2025/02-24/269393.html",
            "path": RAW_DIR / "province_fiscal" / "2024" / "official" / "jiaozuo_2024_fund_analysis_excerpt.txt",
            "document_title": "焦作市财政分析（2024年财政收支情况）",
            "publisher": "焦作市财政局",
            "publisher_level": "市级财政机构",
            "publication_date": "2025-02-24",
            "source_grade": "A2",
            ...
            "data_status": "execution",
            "data_status_label": "2024年执行数",
            "document_type": "城市财政分析官方网页摘录",
            "page_number": "官方网页正文；政府性基金预算收入；全市口径",
            "custom_patterns": {
                "gov_fund_revenue_100m": r"城市=焦作市｜年度=2024｜政府性基金预算收入=([0-9.,-]+)亿元",
            },
            "source_locator": "jiaozuo_2024_fund_analysis_excerpt.txt；官方网页正文；城市=焦作市；2024年执行数；行政范围=全市",
            "note": "A2焦作市财政局官方财政分析页面；正文明确列示2024年全市政府性基金预算收入完成1.8亿元，采用全市口径，不使用市级或区县分级数。",
        },
    )
)
...
def merge_gotohui_city_series_batch(
    city_year_fiscal: dict[tuple[str, str], dict[str, Any]],
    candidates: Mapping[tuple[str, str], Mapping[str, Any]],
) -> None:
    """按字段合并聚汇公开序列，不能遗漏债务限额/余额字段。

    聚汇适配器同时提供经济财政、基金收入和债务总额序列。这里保留字段级
    来源选择：只补空值或替换 D 级暂存值，不覆盖已有 A1/A2/B1/B2 值。
    """

    for key, candidate in candidates.items():
        prior = city_year_fiscal.get(key)
        if prior is None:
            city_year_fiscal[key] = dict(candidate)
            continue
        ...
        for field in GOTOHUI_CITY_SERIES_FIELDS:
...
def ensure_download(url: str, target: Path) -> str:
    ...
    if not target.exists() or target.stat().st_size == 0:
        ...
        with urlopen(request, timeout=60, context=DOWNLOAD_SSL_CONTEXT) as response, target.open("wb") as output:
...
def main() -> None:
    ...
    merge_gotohui_city_series_batch(city_year_fiscal, gotohui_city_series)
